  ...
  return (
    <>
      <PageContainer maxWidth="4xl" className="policy-page">
        ...
        <section><h2>一、服务范围</h2><p>复利书房提供公开资料检索、阅读与数字巴芒文集产品。公开内容不强制登录；账户用于识别订单、已购产品与相应访问权益。</p></section>
        <section><h2>二、内容边界</h2><p>本站内容用于学习、研究与资料检索，不构成投资建议，不提供收益承诺，也不替用户作出投资决定。</p></section>
        <section><h2>三、数字产品</h2><p>巴芒文集按单本一次性购买。购买所有者的眼光不会自动获得理性的格栅，反之亦然。产品名称、版本、文件形式、价格和更新范围以结账页订单摘要为准。</p></section>
