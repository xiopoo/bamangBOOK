...
const exactRules = [
  ...
  },
  {
    ...
    feature: "过度升维或伪深刻收束",
    severity: "medium",
    pattern: /本质上|归根结底|说到底|最终定义了|真正的答案是|这才是.+?真正|这就是.+?本质|收束|收口|收尾|归结[为到]|凝练成|锚定[在到]|勾勒出|串[起成]全卷/gu,
  },
  {
    id: "F12",
    feature: "小结型抽象动词（AI 味书面腔）",
    severity: "weak",
    pattern: /收束|收口|收尾|归结[为到]|凝练|锚定|勾勒|串[起成](?:为|全卷)|一笔带过地|一言以蔽[之]/gu,
  },
  {
    id: "F13",
    feature: "结论被包装成抽象名词‘判断’",
    severity: "medium",
    pattern: /判断纪律|判断标准|判断框架|判断体系|判断产物|判断落点|判断的尺度|把同一?判断|同一?个判断|核心判断|这个判断|那个判断|这套判断|一项判断|最终判断|整体判断|基本判断|关键判断/gu,
  },
  {
    id: "F06",
    feature: "固定位置的弱连接词",
