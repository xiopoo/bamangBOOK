...
> Warren Buffett is questioned about what he did after learning of accusations over Berkshire executive David Sokol's involvement in the acquisition of Lubrizol and explains why he still finds Sokol's actions "inexplicable."
...
## Q1 earnings hurt by Asian catastrophes
...
## David Sokol and Lubrizol: "inexcusable" and "inexplicable"
...
## Buffett's David Sokol timeline
...
## Market reaction when Fed ends stimulus
...
## Role of Berkshire's next chairman
...
## Picking tech stocks is difficult but could be profitable
...
## Why Buffett got past his skepticism about Lubrizol
...
## Using Berkshire's stock for acquisitions
...
## Buffett is always optimistic about American capitalism
...
## Best assets in an inflationary environment
...
## Still bullish on bank stocks Wells Fargo and U.S. Bancorp
...
## Productive assets will always beat gold
...
## Buffett on getting his first investors
...
## Berkshire isn't a '60s "Go-Go" conglomerate
...
The conglomerates you mentioned — and I'm familiar with all of them — really became sort of stock issuance machines, where the idea was to get your stock to sell at a very high multiple, and then trade it for something else that was selling at a lower multiple, and voilÃ , you know, earnings per share went up, and then people said you'll do it again.
...
## Buffett's preferred legacy: "teacher"
...
## Dollar will decline, but inflation won't destroy the economy
...
## Buy Berkshire stock or a mutual fund?
...
## "Rules are not meant to be danced around"
...
## Deficit spending is economic stimulus
...
## Munger tells how he'd take "an ax to our financial sector"
...
## Update on Buffett's bet against hedge funds
