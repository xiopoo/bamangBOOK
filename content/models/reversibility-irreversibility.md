...
sourceUrl: "https://mungermodels.com/models/reversibility-irreversibility"
---
...
芒格和巴菲特的“[安全边际](/model/margin-of-safety)”概念，本质上就是对不可逆性的保险。当你做一个不可逆决策时——投资一家公司、选择一个人生伴侣、进入一个行业——你不可能完美预见未来。所以你需要留出足够的容错空间。以远低于[内在价值](/model/intrinsic-value)的价格买入股票，不仅是为了赚更多——更是为了给自己留一条退路，即使你的分析有重大错误，损失也在可承受范围内。
...
- [熵](/model/entropy) — 熵增的本质就是不可逆性；热力学第二定律是理解为什么“碎杯不能复原”的物理基础
- [安全边际](/model/margin-of-safety) — 安全边际是对不可逆性的保险机制：既然犯错后无法回头，就在出发前留够容错空间
- [逆向思维](/model/inversion) — “避免灾难”的逆向思维，本质上是识别并规避不可逆的负面结果
- [风险优先](/model/risk-first) — 风险优先原则的底层逻辑：不可逆的风险比可逆的机会更值得关注
- [复利效应](/model/compound-interest) — 复利需要不间断运行，一次不可逆的资本损失会摧毁多年的复利积累
- [临界质量](/model/critical-mass) — 系统跨过临界点后的变化往往是不可逆的，无论是正向引爆还是负向崩塌
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 脆弱系统在面对不可逆冲击时崩溃，反脆弱系统在冲击中变强
