...
sourceUrl: "https://mungermodels.com/models/breakpoints"
---
...
事后的调查报告写了厚厚几百页，但核心发现可以浓缩成一句话：那天的风速只有大约每小时42英里——远低于桥梁的设计风载。桥不是被“太大的风”吹断的。它是被恰好频率的风激发了[共振](/model/resonance)，应力在特定结构节点上持续积累，直到超过材料的极限强度。
...
**特征二：不可逆。** 断裂一旦发生，系统不会回到断裂前的状态。桥塌了不会自己站起来。雷曼破产了不会自己复活。信任碎了不会自己愈合。这与弹性变形截然不同——弹性变形是可逆的，你松手钢条就弹回去。但断裂是穿越了一个不可逆的门槛。这就是为什么断裂点模型与[安全边际](/model/margin-of-safety)天然关联：你必须确保自己永远不要接近断裂点，因为一旦跨过去就没有回头路。
...
3. **在市场层面保持警觉。** 当整个市场的杠杆率、估值水平、投资者情绪同时处于极端高位时，系统的断裂点就在附近。2008年之前如此，2000年之前如此。芒格不试图预测断裂何时发生，但他确保自己在断裂发生时不会被摧毁——回到[冗余备份系统](/model/redundancy)和[安全边际](/model/margin-of-safety)。
...
- [冗余备份系统](/model/redundancy) — 冗余设计的核心目的就是让系统远离断裂点
- [安全边际](/model/margin-of-safety) — 安全边际在投资中的作用，就是确保你和断裂点之间有足够缓冲
- [复利效应](/model/compound-interest) — 断裂（归零）是复利的终极敌人：一次断裂终结所有积累
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 评估断裂风险时需要考虑小概率但灾难性后果的期望损失
- [护城河（Moat）](/model/moat) — 坚固的护城河让企业在竞争压力下远离断裂点
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 人在接近断裂点（即将失去一切）时会做出极端非理性行为
- [逆向思维](/model/inversion) — “我会死在哪里？”正是断裂点分析的起点
- [质量控制](/model/quality-control) — 质量控制通过减少缺陷来降低系统在生产环节触及断裂点的概率
