...
sourceUrl: "https://mungermodels.com/models/burden-of-proof"
---
...
为什么？因为人类心理有一个系统性偏差：我们对好消息的证据标准天然偏低，对坏消息的证据标准天然偏高。当有人告诉你一家公司的增长率将翻倍时，你的大脑会兴奋，[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)会让你下意识地放松警惕——毕竟，如果这是真的，你会赚很多钱。而当有人告诉你一笔投资可能亏损时，你的大脑会排斥这个信息，[避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial)会让你找各种理由不去相信。
...
> “[安全边际](/model/margin-of-safety)这个概念，格雷厄姆的教诲，永远不会过时。”
...
**证据标准不能只在一个方向上调高。** 一个常见的错误是：对买入要求极高的证据标准，对持有或卖出则几乎不要求证据。很多投资者买入时极其谨慎，但一旦持有，就对负面信息视而不见——[避免不一致性倾向](/model/inconsistency-avoidance-tendency)和[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)联手让他们拒绝承认自己可能犯了错。芒格的实践是对称的：买入需要高标准的正面证据，卖出同样需要高标准的负面证据，但关键是——你不能因为买入时做了充分分析就永远不再审视持有的理由。
...
**证据的质量比数量重要。** 芒格反复强调，十条弱证据不等于一条强证据。在法庭上，十个目击证人的模糊描述不如一条清晰的DNA证据。在投资中，十个分析师的买入评级不如一个经过验证的竞争优势。[Lollapalooza倾向](/model/lollapalooza-tendency)告诉我们，多条弱证据的叠加会制造一种虚假的确定感——你以为证据很充分，实际上每一条都经不起交叉质证。
...
2. **对乐观假设施加更高的标准。** 这是一个刻意对抗[过度乐观倾向](/model/overoptimism-tendency)的策略。当你发现自己在降低证据标准来接受一个令人兴奋的结论时——停下来，有意识地把标准调高一级。
3. **对“显而易见”的结论保持警惕。** 当所有证据看起来都指向同一个方向时，你可能不是发现了真相，而是落入了[叙事谬误](/model/narrative-fallacy)——一个太完美的故事通常意味着你遗漏了关键信息。
...
- [安全边际](/model/margin-of-safety) — 安全边际是证据标准在投资估值中的直接应用
- [对抗制与辩证过程](/model/adversarial-system) — 对抗制是检验证据质量的制度化方法
- [过度乐观倾向](/model/overoptimism-tendency) — 乐观偏误导致我们对好消息的证据标准系统性偏低
- [避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial) — 心理否认让我们拒绝承认已有的负面证据
- [叙事谬误](/model/narrative-fallacy) — 完美的叙事会让我们降低对单个证据的审视标准
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 利益关联会扭曲我们对证据的客观评估
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 一旦形成判断，我们会提高接受反面证据的标准
- [贝叶斯定理](/model/bayes-theorem) — [贝叶斯更新](/model/bayesian-updating)是根据新证据动态调整信念强度的数学框架
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 证据标准本质上是对概率阈值的设定
