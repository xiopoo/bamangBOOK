...
sourceUrl: "https://mungermodels.com/models/co-evolution"
---
...
2007年，第一代iPhone发布时，它没有App Store。所有应用都是苹果自己开发的。史蒂夫·乔布斯最初甚至反对第三方应用——他担心[质量控制](/model/quality-control)和安全问题。
...
这个双向反馈循环在十五年间把App Store从500个应用扩展到了超过180万个。但真正值得注意的不是数量的增长，而是**双方在这个过程中如何相互塑造了对方的形态**。
...
3. **从对手身上学习进化信号**：你的竞争对手的每一次创新，都是在告诉你环境正在如何变化。不要只把竞争对手看作威胁，也要把它们看作信息来源——它们的进化方向揭示了市场正在选择什么样的“[适应性](/model/adaptation)特征”。
...
- [进化论](/model/modern-darwinian-synthesis) — 协同进化是自然选择在多物种交互中的扩展
- [红皇后效应](/model/red-queen-effect) — 对抗型协同进化的动态表现：双方不断升级以维持相对位置
- [进化军备竞赛](/model/evolutionary-arms-race) — 协同进化中对抗型关系的极端形式
- [生态系统思维](/model/ecosystem-thinking) — 协同进化发生在生态系统的关系网络中
- [寄生与共生](/model/parasitism-mutualism) — 协同进化的两种基本模式：互利与对抗
- [网络效应](/model/network-effects) — 互利型协同进化在商业中的核心放大机制
- [转换成本](/model/switching-costs) — 协同进化中“锁定”效应的商业表现
- [护城河（Moat）](/model/moat) — 深度协同进化关系是护城河的重要来源
