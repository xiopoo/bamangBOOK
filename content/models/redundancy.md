...
sourceUrl: "https://mungermodels.com/models/redundancy"
---
...
工程师用一个概念来量化冗余的价值：**[单点故障](/model/single-point-of-failure)（Single Point of Failure）**。如果一个系统中存在某个环节，一旦它出问题整个系统就瘫痪，那这个环节就是单点故障。冗余设计的全部目标，就是消除所有单点故障。
...
如果你已经读过[安全边际](/model/margin-of-safety)那篇文章，你可能已经感觉到了——冗余和安全边际几乎是同一个概念的两种表述。
...
> “工程学里面的后备系统是一种非常有用的思想。基本上，[断裂点](/model/breakpoints)理论也是一种非常强大的思维模型。”
...
- [安全边际](/model/margin-of-safety) — 安全边际本质上就是投资领域的冗余设计：为分析错误预留缓冲空间
- [断裂点](/model/breakpoints) — 冗余的反面教材：当系统没有足够冗余，压力积累到断裂点就会突然崩溃
- [复利效应](/model/compound-interest) — 冗余保护了复利链条不被打断，一次归零就终结了所有积累
- [护城河（Moat）](/model/moat) — 宽阔的护城河本质上是企业竞争优势的冗余
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 冗余决策需要权衡小概率高代价事件的期望损失
- [质量控制](/model/quality-control) — 质量控制是在生产过程中构建冗余性和一致性的系统方法
- [避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial) — 拒绝为最坏情况做准备，往往是心理否认在作祟
- [逆向思维](/model/inversion) — 冗余设计的起点是逆向思考：“什么会出错？”
