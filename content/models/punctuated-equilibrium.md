...
sourceUrl: "https://mungermodels.com/models/punctuated-equilibrium"
---
...
**突变的触发。** 那么飞轮什么时候会改变？当一小部分个体被隔离出去的时候。地理隔离、环境灾变、或者仅仅是边缘种群的偶然漂移，都可能创造出一个与主体种群割裂的小群体。在这个小群体中，遗传漂变的力量被放大了——因为基数小，随机事件可以产生巨大的效果。同时，新环境施加了不同的选择压力。在这双重力量下，小群体可以在相对短的时间内发生显著的形态变化。如果这个变化后的群体[适应性](/model/adaptation)更强，它可能会扩张并最终取代原来的物种——在化石记录中留下一个“突变”的印象。
...
**反直觉二：突变往往来自边缘，而非中心。** 在生物学中，新物种最常从母体种群边缘的小型隔离群体中产生。在商业中，颠覆性创新几乎总是来自行业边缘的小公司或“不相关”的外来者——亚马逊之于书店、Netflix之于百视达、特斯拉之于底特律。克莱顿·克里斯滕森的[破坏性创新](/model/disruptive-innovation)理论本质上就是间断均衡在商业语境中的重述：颠覆者从主流玩家不屑一顾的低端市场或新市场起步，在边缘悄悄进化，然后突然侵入并取代主流。
...
- [进化论](/model/modern-darwinian-synthesis) — 间断均衡是对达尔文渐进进化论的重要补充和修正
- [红皇后效应](/model/red-queen-effect) — 均衡期内物种间的持续共进化竞赛
- [竞争性毁灭](/model/competitive-destruction) — 间断期中旧物种/旧企业被取代的过程
- [临界质量](/model/critical-mass) — 触发从均衡态到间断态的阈值概念
- [非线性后果](/model/nonlinear-consequences) — 间断均衡本质上是一种非线性变化模式
- [破坏性创新](/model/disruptive-innovation) — 商业世界中间断均衡的对应物
- [瓶颈效应与创始人效应](/model/bottleneck-effect-founder-effect) — 小群体隔离是间断均衡的核心触发机制之一
