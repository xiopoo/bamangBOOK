...
sourceUrl: "https://mungermodels.com/models/tight-coupling-loose-coupling"
---
...
同样的地震，同样的海啸，同一个国家的核电站——一个成为人类历史上最严重的核事故之一，一个安然无恙。差别不在于“运气”，而在于系统的**耦合度**。
...
**耦合层三：心理传染。** [社会认同倾向](/model/social-proof-tendency)让恐慌像野火一样蔓延——“如果雷曼可以倒，谁不能倒？”所有人同时卖出的决策通过市场价格机制互相强化。
...
2008年金融危机给了这种设计最戏剧性的检验。全球金融系统在连锁崩溃中几乎瓦解。而伯克希尔不仅安然无恙，还以极为有利的条件向高盛、通用电气等巨头注资。松耦合设计不仅保护了伯克希尔免受冲击，还赋予了它在冲击中出击的能力——这就是松耦合与[反脆弱](/model/fragility-antifragility)的结合。
...
**第二个反直觉：完全的松耦合既不可能也不可取。** 一辆汽车的发动机、变速箱和车轮必须紧密耦合才能驱动前进。关键不是消除耦合，而是**在正确的地方保持紧耦合（核心功能的必要协调），在正确的地方保持松耦合（抵御冲击的缓冲和隔离）**。
...
- [正常事故](/model/normal-accidents) — 紧耦合是正常事故理论的核心维度，紧耦合+复杂交互=系统性事故
- [容错设计与优雅降级](/model/fault-tolerance) — 松耦合天然具有更好的容错能力
- [冗余备份系统](/model/redundancy) — 冗余是实现松耦合的核心手段
- [单点故障](/model/single-point-of-failure) — 紧耦合系统更容易产生单点故障
- [安全边际](/model/margin-of-safety) — 松弛和缓冲是工程版本的安全边际
- [规模效应与反效应](/model/scaling-effects-diseconomies-in-engineering) — 规模扩大时如何保持适度的松耦合是关键挑战
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 松耦合系统更接近反脆弱，紧耦合系统更脆弱
- [简单化在商业中的应用](/model/simplicity-in-business) — 简单化本质上是在降低系统的耦合度
- [涌现性](/model/emergence) — 紧耦合系统中的涌现效应传播更快、更猛烈
- [复利效应](/model/compound-interest) — 紧耦合系统中的一次崩溃可能彻底重置复利链条
- [护城河（Moat）](/model/moat) — 企业的护城河在紧耦合的行业环境中可能因系统性崩溃而被冲破
- [逆向思维](/model/inversion) — 松耦合设计的起点：问“什么会让整个系统崩溃”，然后在那里加入缓冲
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 紧耦合系统中的尾部风险概率往往被严重低估
