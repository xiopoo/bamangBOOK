...
sourceUrl: "https://mungermodels.com/models/agency-costs"
---
...
> “那些站在雇主的立场考虑问题的经济学家早就为[激励机制](/model/incentives-economic-view)引起的偏见所产生的后果取了一个名字：'代理成本'。”
...
这三个条件——利益不一致、[信息不对称](/model/asymmetric-information)、监控困难——只要同时存在，代理成本就必然产生。而在现代社会中，这三个条件几乎无处不在。你雇了一个装修工人（你无法判断他是否用了最好的材料），你买了一只基金（你不知道基金经理每天在做什么交易），你投票选了一个政治家（你不知道他在办公室里真正在忙什么）。
...
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 代理成本的根源：激励机制塑造行为
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 人对激励的反应远比理性模型预期的更强烈
- [自视过高的倾向](/model/excessive-self-regard-tendency) — 代理人往往高估自己的能力，给高费率找到“合理”的理由
- [社会认同倾向](/model/social-proof-tendency) — CEO薪酬的“对标”螺旋源于从众心理
- [护城河（Moat）](/model/moat) — 评估企业时必须扣除代理成本对利润的侵蚀
- [安全边际](/model/margin-of-safety) — 代理成本是投资中必须考虑的隐性风险
- [能力圈](/model/circle-of-competence) — 理解代理成本需要穿透表面的费用结构，看到底层的激励逻辑
- [规模优势](/model/economies-of-scale) — 大企业的代理成本往往更高（层级多、监控难）
