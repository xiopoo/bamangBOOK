...
sourceUrl: "https://mungermodels.com/models/contrast-misreaction-tendency"
---
...
**与[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)的危险配合。** 对比效应可以放大或缩小被剥夺感。房产中介的技巧之所以有效，就是因为“噩梦之屋”放大了你对第二套房子的正面感受——你觉得自己“捡到了便宜”（而实际上你只是付了一个正常或偏高的价格）。反过来，当损失是缓慢发生的（温水煮青蛙），对比效应会让被剥夺超级反应的触发阈值永远不被突破——你每天的损失都“不够大”以触发警报，直到累积损失大到不可挽回。柯达和西尔斯都是这种配合效应的受害者。

**与[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)的叠加。** 打折定价之所以有效，不仅仅是因为对比效应——“省了多少钱”的感觉本身就是一种奖励。大脑在处理“100元打折到60元”的信息时，奖励回路会激活——你字面意义上在体验一种快感。这种快感和衬衫的实际价值无关，它是对比信号的副产品。这就是为什么“促销成瘾”是一种真实的消费心理模式：有些人买东西不是因为需要，而是因为打折的感觉本身令人愉悦。
...
**决策触发器二：当你的生活、业务或投资中的某个指标在缓慢恶化的时候。** 不要和上个月或上个季度比——和一年前比，和五年前比。设定一个“长程对比”的习惯：定期把当前状态与一个足够远的历史基准做对比。渐进的衰退之所以危险，正是因为短程对比总是显示“还行”。只有长程对比才能穿透温水煮青蛙的迷雾。芒格建议企业领导者定期做一次“如果一个新CEO明天上任”的[思想实验](/model/thought-experiments)——新CEO不会受到渐进对比的锚定，他会用新鲜的眼睛看到那些你已经习以为常的恶化。
...
- **[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)**：对比效应可以放大或掩盖被剥夺感——渐进的损失因为低对比度而绕过了被剥夺反应的触发阈值
- **[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)**：打折创造的“省钱”快感是对比信号和奖励回路的叠加产物
- **[避免不一致性倾向](/model/inconsistency-avoidance-tendency)**：当缓慢恶化被对比盲区掩盖时，一致性偏见进一步阻止你承认“需要改变”
- **[社会认同倾向](/model/social-proof-tendency)**：当周围的人也在温水中没有跳出来，社会认同会强化“水温还可以”的判断
- **[自视过高的倾向](/model/excessive-self-regard-tendency)**：你高估自己对对比操控的免疫力——“我不会被锚定”本身就是一种自视过高
- **[过度乐观倾向](/model/overoptimism-tendency)**：乐观情绪降低了你对渐进恶化的敏感度——“总会好起来的”让你进一步忽视温水的升温
- **[Lollapalooza倾向](/model/lollapalooza-tendency)**：对比盲区+一致性偏见+社会认同+乐观倾向的叠加，足以让整个组织在缓慢衰退中走向灭亡而无人察觉
...
- [ ] “清除锚点测试”：把所有参照价格从脑中移除，只看当前价格和标的的[内在价值](/model/intrinsic-value)。这个价格本身值得吗？
