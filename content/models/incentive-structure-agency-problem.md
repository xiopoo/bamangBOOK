...
sourceUrl: "https://mungermodels.com/models/incentive-structure-agency-problem"
---
...
> “给我看[激励机制](/model/incentives-economic-view)，我就能预测结果。”
...
**委托-代理关系**是现代社会最基本的组织形式。你请律师替你打官司（你是委托人，律师是代理人），你把钱交给基金经理投资（你是委托人，基金经理是代理人），你投票选出政客管理国家（你是委托人，政客是代理人）。每一次你把决策权交给别人的时候，你就进入了一段委托-代理关系。

问题是：**代理人有自己的利益，而这些利益几乎必然与委托人的利益存在偏差。**

这种偏差不需要代理人是“坏人”才会出现。它是结构性的——只要代理人的报酬机制、考核标准、职业前景与委托人的真实利益不完全一致，偏差就会自动产生。经济学家迈克尔·詹森（Michael Jensen）和威廉·梅克林（William Meckling）在1976年的奠基性论文中把这种偏差造成的价值损失称为“[代理成本](/model/agency-costs)”。但芒格的洞见比学术理论更深一层：他指出，代理问题最具破坏力的地方不在行为层面，而在认知层面——激励机制会在无意识中扭曲代理人的判断本身。

代理问题通过三重机制运作：

**第一重：[信息不对称](/model/asymmetric-information)。** 代理人比委托人更了解实际情况。你的律师比你懂法律，你的医生比你懂医学，你的基金经理比你懂金融。这种信息优势本来是你雇佣他们的原因，但也正是这种优势让你几乎无法判断他们的行为是否真正符合你的利益。当律师告诉你“这个案子必须走完整的证据开示程序”时，你怎么知道这是真的必要还是在制造工作量？你不知道。你只能信任。而信任恰恰是被利用的入口。
...
1. **做一次“联邦快递测试”。** 你设计的激励机制是否在无意中奖励了你不想要的行为？（参见[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)中联邦快递夜班的经典案例。）
2. **让代理人承担下行风险。** 只有上行收益没有下行风险的激励结构，一定会导致过度冒险。芒格在伯克希尔的实践是：子公司CEO的薪酬与他们能控制的业绩挂钩，有赏有罚。
3. **缩短[反馈环](/model/feedback-loops)。** 代理问题之所以在政治中特别严重，一个重要原因是反馈周期太长——今天的决策可能十年后才显现后果。尽可能缩短从“行为”到“结果”到“奖惩”的时间链条。

## 你被代理了多少？

让我们做一个[思想实验](/model/thought-experiments)。列出你生活中所有的委托-代理关系：你的银行、保险公司、投资顾问、律师、医生、会计、房产中介、孩子的老师、你投票选出的政客。现在问自己：在这些关系中，代理人的激励机制与你的利益完全一致的有几个？
...
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 代理问题的心理学基础：激励如何在无意识中扭曲认知
- [信托责任](/model/fiduciary-duty) — 对抗代理问题的法律工具：受托人须将委托人利益置于自身之上
- [对抗制与辩证过程](/model/adversarial-system) — 法律领域用对抗制来部分缓解代理问题
- [道德风险](/model/moral-hazard) — 代理问题的极端形式：当负面后果完全由他人承担
- [安全边际](/model/margin-of-safety) — 在代理关系中为自己预留犯错空间
- [社会认同倾向](/model/social-proof-tendency) — 当群体中的代理人都受同一套错误激励驱动时，群体偏见被放大
- [自视过高的倾向](/model/excessive-self-regard-tendency) — 代理人高估自身能力，低估利益冲突对自己判断的影响
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 代理人一旦因激励形成某种立场，极难改变
