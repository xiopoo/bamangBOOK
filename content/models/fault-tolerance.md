...
sourceUrl: "https://mungermodels.com/models/fault-tolerance"
---
...
**第四个陷阱：过度容错会让系统变得过于复杂。** 每增加一层容错机制就增加一层复杂性，而复杂性本身就是故障的来源。有时候，一个简单而脆弱的系统比一个复杂而“容错”的系统更可靠——因为简单系统的故障模式是可预测的，而[复杂系统](/model/complex-systems)的故障模式可能出人意料。芒格反复强调“简单”的价值：“如果一个东西太复杂了，以至于你理解不了它怎么可能出问题，那它一定会出问题。”
...
- [冗余备份系统](/model/redundancy) — 冗余是容错的基础手段，容错是冗余的系统化升级
- [单点故障](/model/single-point-of-failure) — 容错设计的目标之一就是消除或隔离单点故障
- [安全边际](/model/margin-of-safety) — 安全边际是投资领域的容错策略：为判断错误预留空间
- [断裂点](/model/breakpoints) — 容错设计延迟甚至避免系统到达断裂点
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 容错是从脆弱到坚韧的第一步，反脆弱则是更高层次
- [紧耦合与松耦合](/model/tight-coupling-loose-coupling) — 松耦合设计天然具有更好的容错性
- [故障模式分析](/model/failure-mode-analysis) — FMEA为容错设计提供系统化的故障识别方法
- [逆向思维](/model/inversion) — 容错设计的起点是逆向思考：“什么会出错，出错后会怎样？”
