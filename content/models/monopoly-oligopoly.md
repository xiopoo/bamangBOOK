...
sourceUrl: "https://mungermodels.com/models/monopoly-oligopoly"
---
...
第三层：广告生态系统的[网络效应](/model/network-effects)。Google的搜索广告系统（Google Ads）是全球最大的数字广告平台之一。广告主投入越多资源学习如何在Google上投放广告、优化关键词、管理竞价策略，他们就越不愿意迁移到其他平台——因为学习成本已经沉没了。这是一种[转换成本](/model/switching-costs)的表现。
...
**技术颠覆是第二重风险。** 这与[竞争性毁灭](/model/competitive-destruction)直接相关。一个垄断企业最大的威胁往往不是同行业的竞争者（它已经把他们打败了或阻止了），而是来自完全不同维度的替代方案。IBM曾经垄断大型计算机市场，但个人电脑的出现绕过了它。诺基亚曾经垄断功能手机市场，但智能手机消灭了整个品类。垄断地位保护你免受同维度的竞争，但不保护你免受维度转换的冲击。
...
- [规模优势](/model/economies-of-scale) — 规模经济是形成垄断与寡头的核心路径之一
- [护城河（Moat）](/model/moat) — 垄断和寡头地位就是最深最宽的护城河
- [竞争性毁灭](/model/competitive-destruction) — 垄断者面临的最大威胁不是同行竞争，而是维度颠覆
- [转换成本](/model/switching-costs) — 高转换成本是维持垄断地位的重要机制
- [网络效应](/model/network-effects) — 网络效应是数字时代形成“赢家通吃”垄断的主要动力
- [价格弹性与定价权](/model/price-elasticity) — 垄断地位的最直接体现是定价权
- [激励机制](/model/incentives-economic-view) — 垄断利润可能导致管理层自满，理解激励结构才能评估这种风险
- [供给与需求](/model/supply-and-demand) — 市场结构理论建立在供需分析的基础之上
- [价格歧视](/model/price-discrimination) — 垄断者利用市场支配地位实施价格歧视，对不同客户收取不同价格以最大化利润
