...
sourceUrl: "https://mungermodels.com/models/principal-agent-solutions"
---
...
经济学家在1970年代就正式命名并研究了这个问题。迈克尔·詹森和威廉·梅克林在1976年发表的著名论文《企业理论》中，将[代理成本](/model/agency-costs)定义为“委托人和代理人之间利益不一致所产生的全部成本”——包括监督成本、约束成本和剩余损失。
...
**第一种：努力程度不一致。** 代理人不够努力。你花钱雇了一个人管理你的餐厅，但你不在的时候，他可能提前打烊、对顾客敷衍、不控制成本浪费。因为他拿的是固定工资，多干和少干对他的收入几乎没有影响。这是最基础的代理问题——经济学家称之为“[道德风险](/model/moral-hazard)”。
...
**第三种：[信息不对称](/model/asymmetric-information)。** 代理人知道委托人不知道的事情，并且利用这种信息优势谋取私利。基金经理知道自己的真实业绩归因（是能力还是运气），但投资者不知道。CEO知道下个季度的真实预期，但董事会不完全清楚。审计师知道客户的财务漏洞，但如果揭露出来就会失去这个客户。

这三种表现形式在现实中往往交织在一起。一个上市公司CEO可能同时面临：不够努力做艰难但必要的改革（第一种），为了短期股价冒不必要的战略风险（第二种），在董事会面前粉饰真实情况（第三种）。

芒格对此有一个精辟的总结：

> “告诉我[激励机制](/model/incentives-economic-view)是什么，我就能告诉你结果是什么。”
...
**回购而非期权。** 当公司想奖励管理层时，芒格更支持在股价被低估时回购股票，而非发放期权。回购直接提升了所有现有股东（包括管理层）的持股价值，不会造成稀释，而且只有在股价低于[内在价值](/model/intrinsic-value)时才创造价值——这逼迫管理层对公司的真实价值做出判断。
...
- [代理成本](/model/agency-costs) — 本模型讨论的是代理成本的具体管理解法
- [激励机制](/model/incentives-economic-view) — “告诉我激励机制，我就告诉你结果”——激励设计是解决代理问题的第一工具
- [激励结构设计](/model/incentive-structure-design) — 具体的激励结构设计方法论
- [值得信赖的无缝网络](/model/seamless-web-of-deserved-trust) — 信任网络是降低代理成本的终极形态
- [企业文化作为资产](/model/corporate-culture-as-asset) — 文化是解决代理问题的“软”基础设施
- [信托责任](/model/fiduciary-duty) — 代理人对委托人的法律义务框架
- [道德风险](/model/moral-hazard) — 代理问题在保险和金融领域的特殊表现
- [逆向思维](/model/inversion) — 反过来想：什么样的制度设计会最大化代理成本？
