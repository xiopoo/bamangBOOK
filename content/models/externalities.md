...
sourceUrl: "https://mungermodels.com/models/externalities"
---
...
从芒格的[系统思维](/model/systems-thinking)角度看，社交媒体的负外部性是一个典型的“市场失灵需要外部干预”的场景。市场不会自我纠正这个问题，因为平台的激励是扩大——而不是限制——用户使用时间。这就是为什么越来越多的国家开始对青少年使用社交媒体进行立法限制：不是出于对自由市场的不信任，而是出于对外部性这种市场缺陷的认知。
...
1960年，芝加哥大学的罗纳德·科斯（Ronald Coase）发表了一篇后来为他赢得诺贝尔奖的论文《社会成本问题》。科斯提出了一个看似简单却影响深远的观点：**如果产权明确、[交易成本](/model/transaction-costs)为零，外部性可以通过当事人之间的自愿谈判来解决，不需要政府干预。**
...
科斯定理的深刻之处在于，它揭示了外部性问题本质上是一个**产权不明确**的问题。之所以工厂能免费排污，不是因为市场失灵了，而是因为“清洁的河水”这种资源没有被分配明确的产权。如果空气、水、安静这些“公共品”都有明确的产权归属，市场就能通过交易来处理外部性。
...
芒格的[跨学科思维](/model/multidisciplinary-approach)告诉我们，外部性不是一个抽象的经济学概念——它是理解现实世界中无数现象的关键。
...
- [激励机制](/model/incentives-economic-view) — 外部性的根源在于行为者的激励与社会整体利益不一致
- [会计作为商业语言及其局限](/model/accounting-as-language-its-limits) — 财务报表无法反映外部成本，是外部性导致的信息失真
- [供给与需求](/model/supply-and-demand) — 外部性导致市场均衡偏离社会最优均衡
- [道德风险](/model/moral-hazard) — 当行为后果由他人承担时，行为者倾向于过度冒险，这是负外部性的微观机制
- [规模优势](/model/economies-of-scale) — 规模越大的企业，其外部性（正面或负面）的影响范围也越大
- [护城河（Moat）](/model/moat) — 部分企业的“护城河”实际上建立在未被内部化的外部性之上，需要警惕
- [竞争性毁灭](/model/competitive-destruction) — 新技术可能因为更好地解决外部性问题而颠覆旧产业（如电动车vs燃油车）
- [网络效应](/model/network-effects) — 社交媒体的负外部性与其网络效应驱动的商业模式直接相关
- [公地悲剧](/model/tragedy-of-the-commons) — 公地悲剧是负外部性的经典场景：个体理性导致集体资源耗竭
