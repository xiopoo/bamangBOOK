...
sourceUrl: "https://mungermodels.com/models/modern-darwinian-synthesis"
---
...
看看伯克希尔的核心持仓：可口可乐存在了130多年，美国运通170多年，苹果虽然“只有”近50年但已经经历了至少三次濒死又重生。这些企业不是因为它们恰好运气好才活了这么久——它们拥有某种深层的“[适应性](/model/adaptation)机制”，使得它们能够在环境不断变化的情况下持续生存。
...
芒格把经济学家熊彼特的“创造性破坏”（creative destruction）和达尔文的自然选择视为同一现象的不同表达。他甚至更进一步，把它直接叫做“[竞争性毁灭](/model/competitive-destruction)”（competitive destruction）。
...
- [生态系统思维](/model/ecosystem-thinking) — 进化论的“舞台”：物种不是孤立进化的，而是在生态系统中共同进化
- [适应性](/model/adaptation) — 进化论的核心输出：适应环境的能力决定生存
- [竞争性毁灭](/model/competitive-destruction) — 熊彼特的创造性破坏，就是商业世界的自然选择
- [护城河（Moat）](/model/moat) — 企业在“自然选择”中存活的关键机制
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多种进化压力同时作用时，变化速度会超出预期
- [红皇后效应](/model/red-queen-effect) — 在共同进化的世界里，你必须不断奔跑才能留在原地
- [逆向思维](/model/inversion) — 达尔文本人最常用的方法：不断尝试推翻自己的理论
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 进化是概率性的，不是确定性的；投资也是
