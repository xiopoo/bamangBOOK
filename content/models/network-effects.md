...
sourceUrl: "https://mungermodels.com/models/network-effects"
---
...
网络效应之所以成为最强大的[护城河（Moat）](/model/moat)之一，是因为它创造了一种极其特殊的竞争动力学：
...
这种多层叠加产生了一种恐怖的[转换成本](/model/switching-costs)：即使有人做出一个在每个单一功能上都胜过微信的应用，你也无法切换——因为你的整个数字生活都绑定在这里了。**网络效应加上转换成本，构成了双重锁定。**
...
芒格的多学科思维在这里尤其有价值。单独理解网络效应是不够的——你还需要用[进化论](/model/modern-darwinian-synthesis)的视角来思考技术范式的变迁，用[临界质量](/model/critical-mass)的概念来判断网络何时达到不可逆的规模，用心理学中的[社会认同倾向](/model/social-proof-tendency)来理解为什么人们倾向于加入最大的网络。
...
- [护城河（Moat）](/model/moat) — 网络效应是最强大的护城河类型之一
- [转换成本](/model/switching-costs) — 网络效应往往与高转换成本叠加，形成双重锁定
- [飞轮效应](/model/flywheel-effect) — 网络效应是飞轮的一种特殊形式：用户增长驱动价值增长驱动用户增长
- [临界质量](/model/critical-mass) — 网络必须达到临界规模才能触发自我维持的增长
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 网络效应+品牌+转换成本叠加时产生的超级效应
- [社会认同倾向](/model/social-proof-tendency) — 人们倾向加入最大网络的心理学基础
- [复利效应](/model/compound-interest) — 网络价值的超线性增长与复利的指数增长共享同一个底层逻辑
- [进化论](/model/modern-darwinian-synthesis) — 技术范式的演化可以绕过甚至摧毁已有的网络效应
- [反馈环](/model/feedback-loops) — 网络效应的底层机制就是正反馈循环
