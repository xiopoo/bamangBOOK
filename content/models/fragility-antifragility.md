...
sourceUrl: "https://mungermodels.com/models/fragility-antifragility"
---
...
更致命的是，金融业的失败信息被系统性地压制了。银行不愿意公开承认自己的风险模型有缺陷（面子问题和监管压力），交易员亏损后倾向于隐瞒而不是上报（[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)），评级机构给次级贷款打3A评级因为那是它们的收入来源。整个系统不断积累隐性风险却缺乏从失败中学习的机制——这是脆弱性的完美配方。
...
**边界条件一：反脆弱需要生存。** 反脆弱的前提是你能在冲击中存活下来。如果压力大到直接杀死了你，就没有“变更强”这回事了。举重让肌肉更强壮，但如果你试图举起超过自身极限十倍的重量，你得到的不是超量补偿，而是断裂的肌腱。同理，伯克希尔能在2008年反脆弱地出手，前提是它的财务结构确保了它在任何情况下都不会破产。反脆弱策略必须和[安全边际](/model/margin-of-safety)配合使用——先确保生存，再追求从压力中获益。
...
- [安全边际](/model/margin-of-safety) — 安全边际是反脆弱的前提：先确保生存，才能从压力中获益
- [紧耦合与松耦合](/model/tight-coupling-loose-coupling) — 松耦合设计是反脆弱的结构性基础
- [涌现性](/model/emergence) — 反脆弱性本身是一种涌现属性——从系统设计的多个要素互动中产生
- [护城河（Moat）](/model/moat) — 反脆弱的企业拥有在压力下反而变宽的护城河
- [复利效应](/model/compound-interest) — 反脆弱保护复利链条不在危机中断裂，甚至利用危机加速复利
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 反脆弱的数学本质是非对称回报：下行有限，上行无限
- [逆向思维](/model/inversion) — 反脆弱思维的第一步：不是问“如何赚更多”，而是问“什么会杀死我”
- [生态系统思维](/model/ecosystem-thinking) — 健康的生态系统本质上是反脆弱的——物种灭绝推动生态进化
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 人类在“失去”的威胁下反而迸发出巨大能量——这是心理层面的反脆弱
