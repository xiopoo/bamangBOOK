...
sourceUrl: "https://mungermodels.com/models/drug-misinfluence-tendency"
---
...
芒格在讨论化学物质错误影响倾向时，特别强调了它与[避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial)的致命叠加。事实上，化学物质依赖可能是心理否认最极端、最顽固的展示场景。
...
这种严厉不是修辞。它反映了芒格的一个基本判断：大多数人类误判心理学倾向虽然会导致错误决策，但它们通常不会摧毁你的决策能力本身。你可能因为[社会认同倾向](/model/social-proof-tendency)做了一个从众的蠢决定，但你事后可以认识到错误并纠正。你可能因为[自视过高的倾向](/model/excessive-self-regard-tendency)高估了自己的能力，但当证据足够多的时候你可以（虽然不情愿地）调整判断。但化学物质依赖不一样——它直接攻击的是你做出理性判断的生物学基础设施。它不只是让你做出错误的决策，它让你丧失识别错误和纠正错误的能力。它是认知偏差中唯一一个能够物理性地摧毁你的纠错机制的。
...
- **[避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial)**：成瘾者的心理否认是化学物质依赖能够持续的核心防御机制——药物本身还会在化学层面增强否认
- **[压力影响倾向](/model/stress-influence-tendency)**：许多人用化学物质来“管理”压力，创造了一种以毒攻毒的恶性循环
- **[社会认同倾向](/model/social-proof-tendency)**：饮酒和用药文化中的社会认同压力是成瘾的重要入口——“大家都在喝”降低了个体的警觉
- **[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)**：化学物质提供的即时、强烈的奖赏信号劫持了奖赏系统，使所有其他激励都显得苍白
- **[自视过高的倾向](/model/excessive-self-regard-tendency)**：高估自己控制用量的能力——“我和那些成瘾者不一样”——是通向依赖的常见心理入口
- **[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)**：戒断过程中“被剥夺”愉悦感的强烈反应，是复吸率居高不下的重要原因
