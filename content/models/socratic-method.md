...
sourceUrl: "https://mungermodels.com/models/socratic-method"
---
...
是技术专利？品牌忠诚？[转换成本](/model/switching-costs)？还是纯粹的先发优势？不同类型的护城河有截然不同的持久性。
...
也许最重要的追问要指向提问者自己。我为什么觉得这家公司有吸引力？是因为冷静的分析，还是因为我最近看了太多关于这个行业的正面报道（[错误衡量易得性倾向](/model/availability-misweighing-tendency)）？是因为真正的价值发现，还是因为我的朋友们都在买这只股票（[社会认同倾向](/model/social-proof-tendency)）？
...
**第四个边界：追问需要知识基础。** 苏格拉底之所以能提出精准的追问，是因为他对被追问的领域有深入的理解。你不能对一个你一无所知的领域进行有效的追问——你甚至不知道该问什么。这就是为什么芒格强调[终身学习](/model/lifelong-learning)和[跨学科思维](/model/multidisciplinary-approach)：追问的深度取决于你知识的广度。一个只懂财务的分析师能追问利润率的问题，但只有一个同时懂技术、竞争动态和人性的分析师才能追问到真正关键的问题。
...
- [逆向思维](/model/inversion) — 苏格拉底式追问的天然盟友，“反过来想”本质上就是对自己的结论进行追问
- [避免意识形态偏见](/model/avoiding-ideology) — 追问是对抗意识形态僵化的最佳武器，意识形态最怕被追问“凭什么”
- [检查清单方法](/model/checklist-method) — 检查清单是将追问系统化的工具，把关键追问固化为标准流程
- [独立思考](/model/independence) — 追问的前提是你敢于质疑共识，不被权威和多数人意见所吓退
- [能力圈](/model/circle-of-competence) — 追问帮助你诚实地界定能力圈的边界：你真的理解这个领域吗？
- [双轨分析](/model/adversarial-system) — 追问包括理性分析和心理偏误两条轨道，既追问事实也追问动机
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — 不追问就容易陷入“手里有锤子，看什么都像钉子”的思维定势
