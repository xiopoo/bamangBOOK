...
sourceUrl: "https://mungermodels.com/models/niche-differentiation"
---
...
- [生态系统思维](/model/ecosystem-thinking) — 利基分化是生态系统中物种共存的核心机制
- [进化论](/model/modern-darwinian-synthesis) — 利基分化是自然选择的一种重要表现形式
- [红皇后效应](/model/red-queen-effect) — 利基分化可以帮助“退出”消耗性的红皇后竞赛
- [护城河（Moat）](/model/moat) — 利基优势是护城河的一种重要来源
- [能力圈](/model/circle-of-competence) — 找到利基的过程，就是识别和坚守能力圈的过程
- [竞争性毁灭](/model/competitive-destruction) — 未能找到利基的企业最终面临被淘汰的命运
- [规模优势](/model/economies-of-scale) — 在利基市场中，即使绝对规模不大也能享有相对规模优势
- [进化军备竞赛](/model/evolutionary-arms-race) — 利基分化是避免陷入消耗性军备竞赛的替代策略
- [趋同进化](/model/convergent-evolution) — 不同物种在相似的生态位中独立演化出相似的解决方案，印证了利基的决定性塑造力
