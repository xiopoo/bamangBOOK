...
sourceUrl: "https://mungermodels.com/models/natural-selection-survival-of-the-fittest"
---
...
自然选择不是一个模糊的隐喻。它是一台精密的机器，由三个不可缺少的部件构成，每一个都不可或缺。（注：本知识库中的[进化论](/model/modern-darwinian-synthesis)一文已系统阐述了变异→选择→遗传的三齿轮框架。本篇聚焦于“选择”这个齿轮本身的运作机制及其常见误读。）
...
这项研究对投资者的启示是深刻的。企业的“[适应性](/model/adaptation)特征”——产品、文化、商业模式——在某种环境下是优势，在另一种环境下可能变成劣势。2019年之前，以实体店为核心的零售商是“适者”的一部分。2020年疫情改变了环境，突然间电商能力变成了生存的关键特征。环境恢复后，纯线上模式又暴露出了缺乏体验感的弱点。“最适”永远是一个移动靶。
...
自然选择给我们的终极启示，不是“适者生存”这句口号，而是一种深层的[认知谦逊](/model/intellectual-humility)。
...
- [进化论](/model/modern-darwinian-synthesis) — 本篇聚焦选择机制本身，进化论篇涵盖变异→选择→遗传的完整框架
- [适应性](/model/adaptation) — “最适”意味着最适应当前环境，适应性篇深入探讨适应能力
- [红皇后效应](/model/red-queen-effect) — 选择压力永不停止，适者生存是暂时的动态平衡
- [协同进化](/model/co-evolution) — 选择压力的来源不只是环境，还包括其他正在进化的物种
- [利基分化](/model/niche-differentiation) — 选择机制推动不同物种占据不同生态位
- [逆向思维](/model/inversion) — “避免致命错误”比“追求完美”更重要——选择的减法逻辑
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 自然选择是概率性而非确定性的
- [可证伪性标准](/model/falsifiability-criterion) — 波普尔将科学进步类比为假说的自然选择
