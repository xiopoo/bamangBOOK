...
scenarios:
  - "团队管理与组织决策"
  - "谈判、说服与人际影响"
description: "激励机制不仅改变行为，更会在无意识中扭曲认知本身。芒格将其列为25个心理倾向之首，并坦言自己一辈子都低估了激励的力量。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/reward-and-punishment-superresponse-tendency"
---
...
芒格把“奖励和惩罚超级反应倾向”列为人类误判心理学25个倾向中的第一个。这不是随意排序。在他看来，理解[激励机制](/model/incentives-economic-view)是理解一切人类行为的最强单一透镜。
...
**第三层：系统层面。** 当一个组织中的每个人都受到同一套错误激励的驱动时，个体层面的认知扭曲会在群体中[共振](/model/resonance)放大。这时候你不会看到“一群人明知故犯”，你会看到“一群聪明人真心相信一件荒谬的事”。这就是华尔街2008年的真实图景——不是阴谋，而是系统性的激励导致的集体认知失调。
...
联邦快递的故事发生在一个仓库里，涉及的是计件薪酬这种简单变量。但激励超级反应真正展现其毁灭性力量，是在[复杂系统](/model/complex-systems)中——比如2008年金融危机之前的华尔街。
...
芒格事后评论说，这不是几个坏人的问题，而是一个“[激励结构设计](/model/incentive-structure-design)得如同犯罪邀请函”的问题。
...
**与其他模型的区别。** 激励超级反应容易和几个相似概念混淆。**代理问题**（principal-agent problem）关注的是“激励不一致”带来的制度性后果，是激励超级反应在组织层面的表现。**[铁锤人倾向](/model/man-with-a-hammer-syndrome)**（Man-with-a-Hammer Tendency）——手里拿着锤子的人把一切都看成钉子——芒格实际上认为它是激励偏见的子概念：一个人花了多年学习某种方法论，他的“激励”就是证明这种方法论有用。**[道德风险](/model/moral-hazard)**（moral hazard）则是激励超级反应在风险分配不对称时的特殊表现：如果亏了别人买单，冒险就变成了“理性选择”。
...
- **[避免不一致性倾向](/model/inconsistency-avoidance-tendency)**：人们一旦因激励而形成某种信念，会拒绝改变它
- **[自视过高的倾向](/model/excessive-self-regard-tendency)**：高薪职位使人高估自己的能力和贡献
- **[社会认同倾向](/model/social-proof-tendency)**：当群体中的激励结构一致时，群体偏见会被放大
- **[代理成本](/model/agency-costs)**：激励偏见的直接制度后果——代理人的利益与委托人不一致
- **[铁锤人倾向](/model/man-with-a-hammer-syndrome)**：芒格将其视为激励偏见的一种表现——手里拿着锤子的人有动机把一切都看成钉子
- **[道德风险](/model/moral-hazard)**：当负面后果由他人承担时，风险行为的激励被放大
- **[Lollapalooza倾向](/model/lollapalooza-tendency)**：当激励偏见与其他心理倾向叠加，会产生极端的非理性后果
