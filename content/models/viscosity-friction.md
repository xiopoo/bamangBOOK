...
sourceUrl: "https://mungermodels.com/models/viscosity-friction"
---
...
在所有商业中的摩擦力形式中，[转换成本](/model/switching-costs)是最直接、最强大、也最被芒格重视的。
...
- [转换成本](/model/switching-costs) — 转换成本是摩擦力在商业中最直接的表现形式
- [护城河（Moat）](/model/moat) — 护城河的核心机制之一就是摩擦力——让竞争者和客户的“运动”变得困难
- [熵](/model/entropy) — 摩擦力把能量转化为不可用的热能，是熵增的微观机制之一
- [催化剂](/model/catalysts) — 催化剂降低的“活化能”可以理解为化学反应中的摩擦力
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 心理层面的“习惯惯性”是个人层面的粘滞性
- [竞争性毁灭](/model/competitive-destruction) — 当摩擦力降低到极低时，竞争强度急剧上升，可能导致全行业毁灭性竞争
- [飞轮效应](/model/flywheel-effect) — 飞轮启动的最大障碍是静摩擦力，一旦克服后动摩擦力相对较小
