...
sourceUrl: "https://mungermodels.com/models/physics-envy"
---
...
芒格认为，这些问题的共同根源就是物理学妒忌——用适合物理学的方法论标准来衡量和指导本质上不同的学科。物理学的精确性来自于其研究对象的简单性和稳定性。当研究对象变成了人类社会这样一个[复杂适应系统](/model/complex-adaptive-systems)时，追求同等程度的精确性不仅徒劳，而且有害——因为虚假的精确感比坦诚的模糊更危险。
...
3. **保持对尾部风险的敬畏。** 不要假设极端事件“不会发生”。芒格的做法是在所有重要决策中为极端情况留出余地——这就是[安全边际](/model/margin-of-safety)的本质。
...
- [奥卡姆剃刀](/model/occams-razor) — 物理学妒忌是简单性原则的对立面：前者追求虚假的精确，后者追求真实的清晰
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — 数学工具就是物理学妒忌者手中的铁锤，他们用它锤所有的问题
- [跨学科思维](/model/multidisciplinary-approach) — 跨学科思维要求你理解不同学科的方法论边界，而不是把一个学科的方法强加于其他学科
- [能力圈](/model/circle-of-competence) — 认识到数学模型的局限性是能力圈意识的重要组成部分
- [安全边际](/model/margin-of-safety) — 安全边际是对物理学妒忌的实用解药：既然你的模型不可能精确，就留出足够的缓冲
- [二阶效应](/model/second-order-thinking) — 物理学妒忌者常忽略模型改变参与者行为的二阶效应（反身性）
