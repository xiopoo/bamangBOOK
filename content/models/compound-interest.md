...
sourceUrl: "https://mungermodels.com/models/compound-interest"
---
...
芒格说得直白：“首先不要亏钱，然后让复利工作。”每一次归零或者大幅回撤，都会重置复利的计时器。你亏了50%，需要涨100%才能回到原点。你亏了90%，需要涨900%。数学是残酷的。这就是为什么芒格和巴菲特如此执着于[安全边际](/model/margin-of-safety)——不是因为保守，而是因为他们深刻理解：**保护复利链条不断裂，比追求更高的年化收益率重要得多。**
...
芒格的多元思维模型体系本身就是知识复利的产物。他不是某一天坐下来列了一张清单，说“我需要这100个模型”。而是几十年的跨学科阅读自然地让模型之间产生了连接——他发现心理学的[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)可以解释经济学中的激励扭曲，发现物理学的[临界质量](/model/critical-mass)概念可以类比到商业中的[飞轮效应](/model/flywheel-effect)，发现生物学的[进化论](/model/modern-darwinian-synthesis)可以解释市场竞争的动态。每一个新连接都让整个知识网络更强大，也更容易吸纳下一个新连接。
...
**第一个陷阱：忽略复利的前提条件。** 复利要求回报持续发生且不被打断。在真实世界中，这个条件远比你想象的难以满足。通货膨胀在侵蚀你的实际回报；税收在每年削减你的本金；[交易成本](/model/transaction-costs)和管理费在持续抽血；黑天鹅事件可能让你的资产在一天之内腰斩。纸面上的“年化10%持续50年”在现实中几乎不存在。巴菲特之所以是奇迹，恰恰是因为他在82年里避开了所有可能归零的灾难——这件事的难度远超“每年赚20%”。
...
复利效应在芒格的整个投资哲学中占据底层位置。他寻找的那些拥有宽阔[护城河（Moat）](/model/moat)的企业，本质上就是能让复利持续运转而不被打断的企业——它们的竞争优势随时间自我加强，利润可以持续再投资于高回报的项目，护城河越来越宽，复利越滚越快。
...
- [护城河（Moat）](/model/moat) — 护城河让企业的复利不被竞争打断
- [排列组合原理](/model/permutations-and-combinations) — 理解复利链条断裂的概率分析
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 评估长期复利回报时需要概率加权
- [飞轮效应](/model/flywheel-effect) — 飞轮是复利在商业系统中的具象化
- [安全边际](/model/margin-of-safety) — 保护复利链条不断裂的关键机制
- [逆向思维](/model/inversion) — 反过来想：什么会打断复利？然后避免它
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 解释为什么坚持长期复利策略如此困难——人们忍不住要“做点什么”
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多种复利效应叠加产生的超级结果
