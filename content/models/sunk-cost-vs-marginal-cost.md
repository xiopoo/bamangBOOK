...
sourceUrl: "https://mungermodels.com/models/sunk-cost-vs-marginal-cost"
---
...
航空公司很清楚这笔账：一个空座位飞过去，收入是零，成本也几乎是零（连那8美元都省了）。但一个空座位的[机会成本](/model/opportunity-cost)——它本可以产生的收入——可能是87美元、200美元或者更多。所以在起飞前的最后时刻，哪怕以87美元的“跳楼价”卖出这个座位，航空公司都在赚钱——因为87美元远高于8美元的边际成本。

这就是边际成本思维的力量：**你的决策应该基于“从现在起多做一件事需要多花多少”，而不是基于“过去总共花了多少”。**

芒格把[沉没成本谬误](/model/sunk-cost-fallacy)列为人类最常见的误判之一。但他对这个问题的思考不止于心理学层面的“认知偏差”——他更强调的是，正确的成本思维框架应该是什么样的。那个框架就是：**忘掉沉没成本，只看边际成本和边际收益。**
...
芒格在心理学框架中把这种倾向归入了[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)和[避免不一致性倾向](/model/inconsistency-avoidance-tendency)——人们不愿意承认过去的决定是错的，不愿意接受已投入的资源“白费了”的事实。但在本篇中，我们关注的不是心理学层面的“为什么人们会犯错”，而是会计/经济学层面的“正确的思考方式是什么”。
...
在那个时间点上，三星面临的决策应该是纯粹的[边际分析](/model/marginal-analysis)：**从现在起，完成这座工厂还需要多少追加投入？这些追加投入能带来多少回报？这个回报率是否高于把同样的钱投到其他地方？**
...
这种逻辑的荒谬性，在芒格看来，可以用一个简单的[思想实验](/model/thought-experiments)来揭示：**假设你今天刚刚接手这家公司，之前的投资和你没有任何关系。你只有手上这笔追加资金。你会选择把它投入这个前景暗淡的工厂项目，还是投入到其他更有前途的方向？**
...
**继续学编程的边际成本**：还需要一年时间和精力，放弃这一年本可以用于学习数据分析的机会（[机会成本](/model/opportunity-cost-in-accounting)）。
...
正确的区分是：**在资源分配和经济决策中，严格应用边际分析。在人际关系和信任建设中，承认历史投入的[内在价值](/model/intrinsic-value)。**
...
- [沉没成本谬误](/model/sunk-cost-fallacy) — 心理学视角：为什么人类大脑会犯这个错误的认知机制分析
- [机会成本会计视角](/model/opportunity-cost-in-accounting) — 忽略机会成本和执着沉没成本是同一枚硬币的两面
- [机会成本](/model/opportunity-cost) — 边际分析的完整框架：每个选择都应与最佳替代方案比较
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 沉没成本谬误的心理根源之一：害怕“失去”已投入的东西
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 人们不愿承认过去的决定是错的，所以继续追加投入
- [现金流量vs利润](/model/cash-flow-vs-earnings) — 现金流分析天然聚焦于未来的流入流出，是边际思维在财务分析中的体现
- [逆向思维](/model/inversion) — “清零测试”就是一种逆向思维：如果从零开始，我还会做同样的选择吗？
