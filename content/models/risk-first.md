...
sourceUrl: "https://mungermodels.com/models/risk-first"
---
...
**第三层：看不见的风险才是真正的风险。** 你能清晰列出的风险——竞争加剧、政策变化、经济衰退——往往不是最危险的，因为你已经意识到了它们，可以做出应对。真正致命的是你没有想到的风险：你不知道公司的财务报表有造假，你没有预料到技术路线的根本转向，你低估了管理层的[道德风险](/model/moral-hazard)。芒格因此强调“声誉风险”——一家公司或一个人的声誉受损往往来自那些看似不可能但一旦发生就不可逆的事件。安然的股东在2001年之前从未把“大规模会计欺诈”列入风险清单。
...
芒格很早就理解了这个悖论。当所有人都认为某项投资没有风险时，它的价格会被推高到不合理的水平，[安全边际](/model/margin-of-safety)消失殆尽。与此同时，所有参与者都降低了警惕，减少了对冲，增加了杠杆。“安全”的共识本身制造了最大的不安全。
...
1. **颠倒思维顺序。** 拿到一个投资机会，强迫自己先花至少一半的分析时间在风险上。列出所有可能出错的地方——不是为了否定这笔投资，而是为了在充分理解下行空间之后再评估上行空间。芒格的[逆向思维](/model/inversion)在这里是最好的工具：“告诉我我会死在哪里，我就不去那里。”
...
- [安全边际](/model/margin-of-safety) — 风险优先的自然延伸：测量风险之后，用安全边际来缓冲风险
- [逆向思维](/model/inversion) — 风险评估的核心工具：“告诉我我会死在哪里”
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 风险量化的数学基础：不只看可能性，更看后果的严重性
- [市场先生](/model/mr-market) — 市场情绪极端时往往是风险被错误定价的时刻
- [自视过高的倾向](/model/excessive-self-regard-tendency) — 风险评估的最大敌人：高估自己的判断力导致低估风险
- [过度乐观倾向](/model/overoptimism-tendency) — 人类天然倾向于低估风险、高估收益
- [冗余备份系统](/model/redundancy) — 工程学中的风险优先思维：为最坏情况预留冗余
