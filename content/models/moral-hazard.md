...
sourceUrl: "https://mungermodels.com/models/moral-hazard"
---
...
这不是一个[思想实验](/model/thought-experiments)。这几乎就是2008年金融危机前华尔街的真实写照。
...
**第一，[信息不对称](/model/asymmetric-information)。** 道德风险发生的前提是一方无法完全观察另一方的行为。保险公司签了保单之后，无法24小时跟踪你是否锁了门、是否酒后驾车、是否在厨房里玩火。雇主无法时刻监控员工是否在认真工作。股东无法实时了解CEO的每一个决策。这种信息差是道德风险的土壤。
...
这也是芒格反复强调的一点。他从来不把道德风险归咎于“人性贪婪”这种空洞的说法。他关注的是**制度设计**：

> “让我看看[激励机制](/model/incentives-economic-view)，我就能告诉你结果。”
...
保险业的数据证实了这一点。有充分证据表明，有保险的人比没有保险的人出险频率更高，而且差异不小。这不是因为“容易出事的人更爱买保险”（那是[逆向选择](/model/adverse-selection)，另一个相关但不同的问题），而是因为**同一个人，在有保险和没保险的状态下，行为真的不一样**。
...
3. **简化而非复杂化。** 道德风险在[复杂系统](/model/complex-systems)中最容易隐藏。当一个金融产品复杂到没人能理解其中的风险分配时，几乎可以确定有人在利用道德风险获利。保持简单，让风险可见。
...
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 道德风险是代理问题最重要的表现形式之一
- [逆向选择](/model/adverse-selection) — 道德风险发生在合同签订之后（事后），逆向选择发生在合同签订之前（事前），两者共同构成信息不对称的核心问题
- [规模优势](/model/economies-of-scale) — “大而不倒”本质上是规模优势与道德风险的危险结合
- [安全边际](/model/margin-of-safety) — 投资中对抗道德风险的实践：假设管理层可能不够审慎，留足安全边际
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多种道德风险叠加时（薪酬结构+证券化+政府担保），效果不是加法而是乘法
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 道德风险的心理学基础：人对激励的反应远超你的想象
- [外部性](/model/externalities) — 道德风险产生的成本往往以负外部性的形式由第三方承担
- [护城河（Moat）](/model/moat) — 企业的风险管理文化可以是一种隐形护城河
