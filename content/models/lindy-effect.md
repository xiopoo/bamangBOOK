...
sourceUrl: "https://mungermodels.com/models/lindy-effect"
---
...
每多存活一年，一个事物就证明了一件事：**它具备某种深层的[适应性](/model/adaptation)——对变化中的环境、对新的竞争者、对不断演变的需求，它都有足够的抗性。** 存活本身就是信息。存活的时间越长，包含的信息越多。

这与[自然选择与适者生存](/model/natural-selection-survival-of-the-fittest)的逻辑是同构的。在生物进化中，一个物种存在的时间越长，说明它在多种环境条件下都具备足够的适应性。同样，在商业世界中，一家企业存活的时间越长——前提是它不是靠政府补贴或垄断保护苟活——说明它的商业模式对多种市场条件都具备韧性。
...
**边界二：[幸存者偏差](/model/survivorship-bias)。** 我们只能观察到“存活下来的”事物，看不到那些在同一时期诞生但已经消失的事物。1886年可能有几百种新饮料被创造出来，其中只有可口可乐存活至今。从可口可乐的存活中推断“林迪效应成立”是合理的，但不能据此推断“所有存活了很久的东西都会继续存活”——它们中的一部分正处于衰亡的边缘，只是我们还看不到。
...
3. **对“新范式”保持怀疑**。每隔几年市场就会出现“这次不一样”的叙事——新经济、加密货币革命、元宇宙。林迪思维提醒你：一个尚未经过时间检验的概念，其消亡的概率远高于存活的概率。这不意味着它一定会失败，而是意味着你应该要求更高的[安全边际](/model/margin-of-safety)。
...
- [自然选择与适者生存](/model/natural-selection-survival-of-the-fittest) — 林迪效应是商业世界中的适者生存原理
- [护城河（Moat）](/model/moat) — 时间验证过的商业模式通常具有深厚的护城河
- [品牌认同](/model/brand-power) — 品牌的林迪属性：存在越久，心智印刻越深
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 林迪式事物不仅抗脆弱，而且从时间中获益
- [幸存者偏差](/model/survivorship-bias) — 林迪分析的主要陷阱
- 切斯特顿之篱 — 尊重已存在事物的智慧
- [能力圈](/model/circle-of-competence) — 芒格偏好经过时间检验的领域
- [复利效应](/model/compound-interest) — 林迪式企业的优势随时间复利累积
- [路径依赖与锁定](/model/path-dependence-lock-in) — 长期存在的事物受益于路径依赖
