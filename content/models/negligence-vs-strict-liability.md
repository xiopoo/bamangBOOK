...
sourceUrl: "https://mungermodels.com/models/negligence-vs-strict-liability"
---
...
**过失责任**的核心逻辑是：你做错了什么？它问的是行为——你是否尽到了一个“合理的人”（reasonable person）在同样情况下应尽的注意义务。要让一个人或企业承担过失责任，原告必须证明四个要素全部成立：被告对原告负有注意义务（duty of care）；被告违反了这一义务（breach）；这种违反与损害之间存在因果关系（causation）；原告确实遭受了损害（damages）。四个环节缺任何一个，案子就不成立。

这是大多数人直觉中的“公平”概念——你犯了错才需要负责，如果你已经足够小心了，那损害是意外，你不应该被惩罚。一个外科医生如果按照标准程序操作手术，患者仍然出了问题，过失责任制度会保护这位医生。你不能因为坏结果本身来追究一个尽了合理注意的人。

**严格责任**的逻辑完全不同。它问的不是你做了什么，而是结果是什么。它不关心你多么小心、多么努力、多么善意——**如果你从事的活动导致了损害，你就必须承担责任，句号。** 原告不需要证明被告有任何过失，只需要证明：被告从事了某种活动或销售了某种产品；该活动或产品导致了损害；损害与被告的活动之间存在因果关系。
...
1. **在评估任何制造业或资源类企业时，首先确定它面临的是过失责任还是严格责任。** 如果是严格责任（化工、制药、石油、军工），你必须假设法律风险是不可控的结构性变量，并在估值中为此留出[安全边际](/model/margin-of-safety)。仅仅因为过去没有发生重大诉讼就认为未来不会发生，是一种致命的[错误衡量易得性倾向](/model/availability-misweighing-tendency)。
...
- [信托责任](/model/fiduciary-duty) — 过失标准在信托关系中被提升为更严格的忠实义务
- [安全边际](/model/margin-of-safety) — 严格责任行业的投资尤其需要安全边际来对冲不可控的法律风险
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 责任制度的选择本质上是一种激励设计：严格责任激励企业内化外部成本
- [外部性](/model/externalities) — 严格责任是法律体系强制企业将外部性内化的核心工具
- [道德风险](/model/moral-hazard) — 有限责任制度可能削弱严格责任的威慑效果
- [错误衡量易得性倾向](/model/availability-misweighing-tendency) — 投资者因过去未发生诉讼而低估未来法律风险
- [监管俘获](/model/regulatory-capture) — 行业可能通过影响立法来改变对自己不利的责任制度
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 严格责任下的法律风险需要用期望值而非最可能值来评估
