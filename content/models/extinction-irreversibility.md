...
sourceUrl: "https://mungermodels.com/models/extinction-irreversibility"
---
...
**致命的[反馈环](/model/feedback-loops)。** 当市场开始质疑雷曼兄弟的偿付能力时，一个致命的正反馈循环启动了：信心下降→交易对手要求更多保证金→雷曼被迫低价出售资产→资产价格下跌→信心进一步下降→更多保证金要求。这个循环一旦启动就无法停止，就像一个生态系统中的“崩溃级联”——一个关键物种的消失触发了其他物种的消失，后者的消失又触发更多物种的消失，直到整个系统崩溃。
...
他不是一个保守的人。他在很多投资上下了很大的赌注——伯克希尔持有的苹果股票一度价值超过1700亿美元。他不害怕[集中持仓](/model/concentration-less-is-more)。他不害怕在正确的时机下重注。
...
- [风险优先](/model/risk-first) — 灭绝与不可逆性是“风险优先”原则的生物学根基
- [安全边际](/model/margin-of-safety) — 安全边际本质上是对灭绝风险的缓冲
- [冗余备份系统](/model/redundancy) — 冗余是对抗不可逆灾难的工程学解决方案
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 理解哪些系统容易“灭绝”、哪些能从冲击中受益
- [进化论](/model/modern-darwinian-synthesis) — 灭绝是进化的终极惩罚：永久退出基因库
- [乘法系统思维](/model/multiplicative-systems) — “乘以零”的数学洞见：一个环节的归零毁灭整个链条
- [故障模式分析](/model/failure-mode-analysis) — 系统性识别可能导致“灭绝”的故障路径
- [适应性](/model/adaptation) — 适应性不足是物种灭绝的根本原因
