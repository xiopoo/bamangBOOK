...
scenarios:
  - "投资决策与资产评估"
description: "人类天生倾向于高估积极结果的概率、低估消极结果的概率，这种神经层面的乐观滤镜导致规划谬误和系统性的风险低估。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/overoptimism-tendency"
---
...
这种差异不能用“信息优势”来解释。创业者确实比外人更了解自己的企业，但他们同样更了解自己企业的问题和风险。差异的真正来源是过度乐观叠加[自视过高的倾向](/model/excessive-self-regard-tendency)：他们既高估了积极结果的概率，又高估了自己应对困难的能力。
...
为什么70年都没有进步？因为过度乐观不是一个可以通过“积累经验”来消除的错误。每一个新项目的规划者都认为“那些超支的项目有他们的特殊原因，我们的项目不一样”——这本身就是过度乐观的表现。此外，[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)也在推波助澜：项目支持者有强烈的激励去低估成本（否则项目不会被批准），而一旦项目启动，沉没成本和政治压力会让所有人继续往前走，而不是在超支20%的时候停下来重新评估。
...
**与[自视过高的倾向](/model/excessive-self-regard-tendency)的区别。** 这两个倾向经常纠缠在一起，但指向不同。自视过高说的是“我比别人强”，过度乐观说的是“事情会比预期更顺利”。一个投资者可能并不认为自己比其他人更聪明（自视过高程度低），但仍然系统性地高估他投资组合的回报率（过度乐观程度高）。反过来，一个极度自视过高的人可能在某些情况下是悲观的——比如他可能认为“我很优秀，但市场环境太差了，所以前景不好”。两者的治疗方案也不同：自视过高需要外部反馈和制度约束，过度乐观需要基准概率和“事前验尸”。
...
芒格的对策不是“变得悲观”。悲观只是另一种形式的偏差。他的对策是**用系统和流程来替代直觉预测**——基准概率、事前验尸、[安全边际](/model/margin-of-safety)、[逆向思维](/model/inversion)。这些工具不是因为你缺乏判断力才需要的，恰恰相反，它们是因为你的判断力天生带着乐观滤镜，所以才需要外部校准。
...
- **[自视过高的倾向](/model/excessive-self-regard-tendency)**：过度乐观的近亲——一个高估结果，一个高估自我，经常叠加出现
- **[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)**：项目支持者有激励去低估成本、高估收益，助长过度乐观
- **[避免不一致性倾向](/model/inconsistency-avoidance-tendency)**：一旦乐观预期形成，人们会拒绝更新，即使新证据指向相反方向
- **[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)**：当乐观预期最终被现实打破时，“落差感”会触发非理性的加码和沉没成本追逐
- **[避免痛苦的心理否认](/model/simple-pain-avoiding-psychological-denial)**：过度乐观的极端形式——当现实太痛苦时，大脑直接否认它
- **[Lollapalooza倾向](/model/lollapalooza-tendency)**：过度乐观+社会认同+激励偏差在泡沫中的叠加效应
