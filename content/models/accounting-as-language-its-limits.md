...
sourceUrl: "https://mungermodels.com/models/accounting-as-language-its-limits"
---
...
- [复式记账法](/model/double-entry-bookkeeping) — 理解会计语言的基础结构
- [现金流量vs利润](/model/cash-flow-vs-earnings) — 会计局限性的核心体现：利润可操纵，现金难伪造
- [逆向思维](/model/inversion) — 芒格评估财务报表的方法：先问“这个数字怎么可能是错的”
- [激励机制](/model/incentives-economic-view) — 管理层操纵会计数字的根本驱动力：奖金、股价、职位安全
- [安全边际](/model/margin-of-safety) — 会计数字的不精确性要求投资者在估值时留出安全边际
- [护城河（Moat）](/model/moat) — 财务报表可以帮助识别护城河，但也可能掩盖护城河的侵蚀
- [避免怀疑倾向](/model/doubt-avoidance-tendency) — 人们倾向于接受精确数字的表面含义，而不追问其背后的假设
- [权威错误影响倾向](/model/authority-misinfluence-tendency) — 审计师签字容易让人放弃独立判断
- [存货计价方法](/model/inventory-valuation-methods) — 存货计价方法的选择（FIFO vs LIFO）是会计假设影响利润的典型案例
