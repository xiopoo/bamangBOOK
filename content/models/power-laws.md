...
sourceUrl: "https://mungermodels.com/models/power-laws"
---
...
你已经了解了[正态与非正态分布](/model/normal-non-normal-distributions)——那条优美对称的钟形曲线。在正态分布的世界里，大部分数据聚集在均值附近，极端值非常罕见，任何单一个体对整体的影响可以忽略不计。把姚明放进一个一千人的房间，平均身高只上升零点几厘米。
...
**财富分布。** 全球最富有的1%的人拥有全球约一半的财富。最富有的前10人的财富总和超过了最贫穷的40亿人的总和。这不是“不公平”的道德问题，而首先是一个数学现象——财富积累的机制（复利、[网络效应](/model/network-effects)、赢家通吃）天然产生幂律分布。
...
**第三，自组织临界性（Self-Organized Criticality）。** 物理学家佩尔·巴克在1987年提出：许多[复杂系统](/model/complex-systems)会自发地演化到一种“临界状态”，在这种状态下扰动大小服从幂律分布。想象一堆沙子：你一粒一粒地往上加，沙堆会自发地达到一个临界坡度。在这个坡度上，加一粒沙子可能什么也不发生，也可能引发大规模沙崩。崩塌大小的分布就是幂律的——没有人“设计”了这种分布，它是系统自发组织的结果。这个概念深刻地关联着[自组织临界性](/model/self-organized-criticality)模型。
...
这也解释了芒格为什么如此强调[能力圈](/model/circle-of-competence)的概念。在幂律世界里，做对一个大决策比做对一百个小决策重要得多。但“做对一个大决策”的前提是你真正深刻地理解了那个领域。芒格一生中只做了不超过二十个重大投资决策，但这二十个决策创造了他几乎全部的财富。
...
**第一，不要在正态分布的领域里使用幂律思维。** 如果你在管理一个工厂的[质量控制](/model/quality-control)，螺丝的直径服从正态分布，你不需要担心“一根螺丝的误差会毁掉整个批次”。在正态世界里，分散和平均化是完全合理的策略。问题是很多人分不清自己处在哪个世界。
...
- **[正态与非正态分布](/model/normal-non-normal-distributions)** — 正态分布与幂律分布是理解世界的两面镜子，知道现象属于哪个分布是正确分析的前提
- **[复利效应](/model/compound-interest)** — 复利是产生幂律分布的核心机制之一；“富者愈富”的正反馈循环驱动复利式增长
- **[网络理论](/model/network-theory)** — 无标度网络中的节点度分布服从幂律，少数超级节点连接了大部分节点
- **[概率思维与期望值](/model/probabilistic-thinking-expected-value)** — 在幂律分布下计算期望值需要特别小心，因为极端事件主导了期望
- **[不对称性与凸性](/model/asymmetry-convexity)** — 幂律分布天然具有不对称性；理解上行和下行的不对称是利用幂律的关键
- **[乘法系统思维](/model/multiplicative-systems)** — 幂律分布往往产生于乘法过程而非加法过程
- **[涌现性](/model/emergence)** — 幂律分布本身是系统动力学的涌现产物
- **[自组织临界性](/model/self-organized-criticality)** — 自组织临界系统自然产生幂律分布的事件规模
- **[临界质量与相变](/model/critical-mass-phase-transitions-in-systems)** — 系统在临界点附近的行为呈现幂律特征
- **[脆弱性与反脆弱性](/model/fragility-antifragility)** — 幂律世界中的尾部风险要求反脆弱的系统设计
- **[能力圈](/model/circle-of-competence)** — 在幂律世界中，把注意力集中在少数真正理解的领域远比分散更有价值
