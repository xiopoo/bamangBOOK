...
sourceUrl: "https://mungermodels.com/models/seamless-web-of-deserved-trust"
---
...
芒格把这种组织形态称为“a seamless web of deserved trust”——一张值得信赖的无缝之网。这个短语中每一个词都经过深思熟虑。“Seamless”意味着没有[断裂点](/model/breakpoints)、没有摩擦接缝；“deserved”意味着信任不是盲目给予的，而是被赢得的；“web”意味着这是一个网状结构而非层级结构，每个节点都直接相连。
...
任何人类协作都面临一个根本问题：你怎么确保合作方会按照约定行事？经济学把这叫做“[交易成本](/model/transaction-costs)”——不是交易本身的成本，而是为了确保交易顺利进行所付出的额外代价。
...
这和伯克希尔的逻辑完全一致。芒格从不幻想人性本善。他相信的是：如果你选对了人，再把[激励机制](/model/incentives-economic-view)设计对，信任就不是一种奢侈品，而是一种自然涌现。
...
- [企业文化作为资产](/model/corporate-culture-as-asset) — 信任网络是企业文化的核心表现形式
- [激励机制](/model/incentives-economic-view) — 正确的激励机制是信任网络的经济基础
- [委托代理问题的管理解法](/model/principal-agent-solutions) — 信任网络是解决委托-代理问题的一种极端高效方案
- [代理成本](/model/agency-costs) — 信任网络通过降低代理成本创造价值
- [规模优势](/model/economies-of-scale) — 信任网络让组织在极大规模下保持低协调成本
- [护城河（Moat）](/model/moat) — 基于信任的组织能力是极难复制的护城河
- [逆向思维](/model/inversion) — 什么会摧毁一张信任网络？一个背信者就够了
