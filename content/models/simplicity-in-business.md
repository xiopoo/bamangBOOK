...
sourceUrl: "https://mungermodels.com/models/simplicity-in-business"
---
...
复杂性的危害不是线性的，而是指数级的。这是因为复杂性的本质是**组合爆炸**。
...
芒格对此评价尖锐。他认为GE Capital的问题不是某个具体的错误决策，而是**复杂性本身**——当一个系统复杂到没有人能真正理解它的全貌时，灾难不是“可能发生”的问题，而是“什么时候发生”的问题。
...
其次，**管理者的自利**。芒格深谙[激励机制](/model/incentives-economic-view)的力量。管辖范围越大、下属越多、业务线越复杂的管理者，通常薪酬越高、地位越高。简单化意味着缩小自己的帝国，这与管理者的个人利益直接冲突。
...
商业中的简单化，最终不是关于做得少，而是关于**理解得深**。只有当你真正理解了一个系统——什么是核心的、什么是多余的、什么看似多余实则关键——你才有资格做减法。否则，你只是在盲目地砍，迟早会砍到动脉。
...
- [护城河（Moat）](/model/moat) — 简单的商业模式往往拥有更持久的护城河
- [飞轮效应](/model/flywheel-effect) — Costco的极简策略构成了自我加强的飞轮
- [能力圈](/model/circle-of-competence) — 简单化与聚焦核心能力相辅相成
- [激励结构设计](/model/incentive-structure-design) — 复杂化背后往往有扭曲的激励结构在驱动
- [转换成本](/model/switching-costs) — [复杂系统](/model/complex-systems)的高转换成本使企业被锁定在复杂性中
- [委托代理问题的管理解法](/model/principal-agent-solutions) — 管理者的帝国建设倾向推动复杂化
- [检查清单方法](/model/checklist-method) — 简单化的工具：用清单替代复杂的决策流程
- [路径依赖与锁定](/model/path-dependence-lock-in) — 一旦走上复杂化道路，回头极其困难
