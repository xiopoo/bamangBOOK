...
sourceUrl: "https://mungermodels.com/models/goodwill-impairment"
---
...
芒格对此的判断极其清醒。他在伯克希尔股东大会上多次指出，大多数收购的溢价中，真正的经济价值远远小于管理层声称的数字。收购公告中那些精心计算的“协同效应”——成本节约、交叉销售、[规模优势](/model/economies-of-scale)——经常无法兑现。但会计商誉已经记在了账上，像一个没人愿意拆开的定时炸弹。
...
客户[转换成本](/model/switching-costs)？几乎为零。手机用户从诺基亚切换到三星或苹果毫无障碍。
...
**第一，区分经济商誉和会计商誉。** 每当你看到一家企业的资产负债表上有大量商誉时，问自己：这些商誉对应的业务是否拥有真正的竞争优势——品牌忠诚度、定价权、客户转换成本、[网络效应](/model/network-effects)？如果有，会计商誉可能低估了经济商誉的价值（就像See's Candies）。如果没有，会计商誉可能大幅高估了实际价值（就像诺基亚手机部门）。
...
- [护城河（Moat）](/model/moat) — 经济商誉的实质就是护城河带来的超额盈利能力
- [现金流量vs利润](/model/cash-flow-vs-earnings) — 商誉减值是非现金费用，区分利润影响与现金流影响是关键
- [折旧与摊销](/model/depreciation-amortization) — 收购产生的无形资产摊销与商誉减值的逻辑密切相关
- [转换成本](/model/switching-costs) — 客户转换成本是经济商誉最重要的来源之一
- [安全边际](/model/margin-of-safety) — 收购溢价越高，安全边际越低；See's的成功在于2500万的价格提供了巨大的安全边际
- [激励机制](/model/incentives-economic-view) — CEO的帝国扩张冲动和投行的交易佣金制度共同推高了收购溢价
