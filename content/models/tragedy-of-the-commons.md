...
sourceUrl: "https://mungermodels.com/models/tragedy-of-the-commons"
---
...
这就是公地悲剧给我们最深刻的教训：**不要抱怨人性，要设计制度。不要期望道德来约束行为，要让正确的行为成为理性的选择。** 当[激励结构设计](/model/incentive-structure-design)正确时，自利的个体会自然而然地保护公地——不是因为他们变得无私了，而是因为保护公地恰好是他们自身利益的一部分。

---

## 芒格原话

> “告诉我[激励机制](/model/incentives-economic-view)，我就能告诉你结果。”
> “Show me the incentive and I will show you the outcome.”
> — Charlie Munger

## 关联模型

- [激励机制](/model/incentives-economic-view) — 公地悲剧的根源在于激励结构，解决方案也在于激励重新设计
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 公司治理中的公地悲剧本质上是代理人问题的一种表现
- [外部性](/model/externalities) — 公地悲剧是负外部性未被内部化的结果
- [博弈论基础](/model/basic-game-theory) — 公地悲剧是一个多人[囚徒困境](/model/prisoners-dilemma)博弈
- [社会认同倾向](/model/social-proof-tendency) — 当所有人都在过度使用公地时，社会证明会加速悲剧
- 合成谬误 — 个体理性导致集体不理性，是合成谬误的经典案例
- 制度与规则 — 制度设计是解决公地悲剧的核心工具
- [逆向思维](/model/inversion) — 设计制度时先想“什么样的激励会产生最坏的结果”
