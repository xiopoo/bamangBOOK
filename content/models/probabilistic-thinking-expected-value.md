...
scenarios:
  - "投资决策与资产评估"
  - "学习、复盘与认知提升"
description: "概率思维与期望值计算是芒格视为生存必备的决策工具，它将思考从二元的会不会发生升级为概率加权的期望值分析，是理性决策的及格线。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/probabilistic-thinking-expected-value"
---
...
当然，现实比这复杂得多。你还需要考虑输50万对你意味着什么——如果那是你全部身家，一次就可能让你破产，即使期望值是正的也不应该玩（这涉及到[安全边际](/model/margin-of-safety)和凯利公式）。但核心逻辑是一样的：**好的决策不是基于“会不会发生”，而是基于“概率加权后的期望值是多少”。**

---

## 赛马场与股市：芒格最爱的类比

芒格解释概率思维时最喜欢用的一个类比是赛马场的[彩池投注系统](/model/pari-mutuel-system)（pari-mutuel system）。这个类比精妙到值得我们仔细拆解。
...
这就是赌场老板的思维。赌场不在乎你今晚赢了10万还是输了10万。它只在乎一件事：每个赌注的期望值是不是对赌场有利。只要期望值是正的，时间和[大数定律](/model/law-of-large-numbers)会替赌场搞定一切。芒格要做的，就是在投资的赌桌上，把自己放在赌场老板的位置。
...
**[贝叶斯更新](/model/bayesian-updating)：概率不是一锤子定死的。** 真正的概率思维不是在一开始估一个数字然后死扛到底。它是动态的——你给出一个初始估计，然后随着新信息的到来不断更新。一开始你估计某公司成功的概率是40%。第一季度财报出来，表现超预期，你把估计更新到55%。管理层发生内斗，你降到35%。这种持续更新的过程就是贝叶斯推理，它是概率思维的动态版本。芒格虽然从不用“贝叶斯”这个词，但他的投资实践就是贝叶斯式的——他会根据新信息不断重新评估自己的判断，绝不顽固地抱着最初的观点不放。
...
概率论的创始人之一帕斯卡提出过一个著名的[思想实验](/model/thought-experiments)。假设你在考虑是否相信上帝存在：上帝存在且你信了，你获得永恒的天堂（无限正收益）；上帝存在但你没信，你遭受永恒的地狱（无限负收益）；上帝不存在且你信了，你浪费了一些时间（有限负收益）；上帝不存在且你没信，你节省了一些时间（有限正收益）。
...
芒格用了七十年来证明这一点。他不是最聪明的人，不是最努力的人，甚至不是运气最好的人。但他可能是最系统性地使用概率思维做决策的人之一。而七十年的正期望值决策累积起来——这又回到了[复利效应](/model/compound-interest)——结果是惊人的。
...
- [复利效应](/model/compound-interest) — 正期望值决策的长期累积就是复利
- [排列组合原理](/model/permutations-and-combinations) — 概率思维的数学基础之一：多事件联合概率
- [护城河（Moat）](/model/moat) — 护城河提升了企业未来成功的概率，使投资的期望值更高
- [安全边际](/model/margin-of-safety) — 安全边际是在概率估计可能出错时保护你的缓冲区
- [逆向思维](/model/inversion) — 反过来算：亏损的概率和幅度是多少？期望值还是正的吗？
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — [激励机制](/model/incentives-economic-view)如何系统性地扭曲人们对概率的判断
- [过度乐观倾向](/model/overoptimism-tendency) — 人们天生倾向于高估好结果的概率、低估坏结果的概率
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多种概率偏差同时作用时的极端效果
- [基本算术与数量级估算](/model/basic-arithmetic-order-of-magnitude-estimation) — 概率思维的前提是基本数感：不会做数量级估算就无法评估概率
- [大数定律](/model/law-of-large-numbers) — 期望值的意义在大量重复决策中才能充分显现
- [不对称性与凸性](/model/asymmetry-convexity) — 当收益和损失不对称时，期望值计算需要特别注意
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 人类对损失的过度敏感系统性地扭曲了我们的期望值判断
