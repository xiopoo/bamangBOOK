...
sourceUrl: "https://mungermodels.com/models/fiduciary-duty"
---
...
**极致的透明。** 伯克希尔的年度股东信是商业写作的巅峰之作，不是因为文笔优美，而是因为信息密度和诚实程度远超行业标准。巴菲特在信中详细解释伯克希尔的[内在价值](/model/intrinsic-value)如何计算、每一笔重大投资的逻辑是什么、哪些判断是对的哪些是错的。他甚至专门用一个章节来讨论“我们可能犯的错误”。这种极致的信息披露，本质上是在降低委托-代理关系中的[信息不对称](/model/asymmetric-information)——你越了解我在做什么，你就越能判断我是否值得信任。
...
**信托责任最大的敌人不是恶意，而是自欺。** 这是芒格反复强调的一点，也是最常被忽视的一点。大多数信托违反不是因为受托人存心害人——他们是真心觉得自己在做对的事。一个为退休基金配置高收费产品的投资顾问，真心相信那个产品更好（恰好他也能拿到更多佣金）。一个给CDO打AAA评级的分析师，真心相信自己的模型是正确的（恰好严格评级会丢客户）。[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)在信托关系中表现得尤为致命——激励导致的认知扭曲让受托人在违背信托责任的同时保持了内心的清白。
...
巴菲特和芒格之所以能以远低于市场的价格收购优质企业，不是因为他们出价最高——恰恰相反。是因为卖家信任他们：信任他们会善待员工，信任他们不会拆分企业，信任他们说到做到。这种信任是几十年信托实践积累出来的，它是伯克希尔最深的[护城河（Moat）](/model/moat)之一——你无法用钱买到它，也无法在短时间内复制它。
...
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 信托责任是对抗代理问题的核心法律与道德工具
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 激励导致的认知扭曲是信托责任的最大隐形敌人
- [护城河（Moat）](/model/moat) — 信托声誉本身就是一种极难复制的竞争优势
- [对抗制与辩证过程](/model/adversarial-system) — 法律体系用对抗制来保障信托义务的执行
- [社会认同倾向](/model/social-proof-tendency) — 当整个行业都在降低信托标准时，从众压力让个体也放松要求
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 一旦建立了信托文化，组织会抗拒偏离这一标准
- [安全边际](/model/margin-of-safety) — 信托实践中的保守主义：宁可多披露不可少披露，宁可少赚不可多冒险
- [复利效应](/model/compound-interest) — 信托声誉的积累如同复利——缓慢但不可阻挡
