...
sourceUrl: "https://mungermodels.com/models/cash-flow-vs-earnings"
---
...
**[折旧与摊销](/model/depreciation-amortization)。** 你三年前花了3000万买了一台机器，利润表上每年记1000万的折旧费用。但实际上你的现金三年前就已经一次性付出去了。所以折旧在冲减利润的同时，并没有对应当期的现金流出——这让经营性现金流看起来比利润高。
...
关键不在于利润和现金流哪个“更高”，而在于**你能否解释它们之间差异的原因，以及这些原因是否合理。** 合理的差异是商业模式的自然特征；不合理的差异是危险的信号。
...
所以芒格的方法不是简单地“只看现金流”，而是**同时看利润、现金流和资产负债表，三者交叉验证**。任何单一指标都可以被操纵，但要同时操纵三张报表的一致性，难度要高得多。
...
5. **用[逆向思维](/model/inversion)检验现金流。** 如果这家企业的经营性现金流看起来特别好，问自己：有没有可能是人为美化的？应付账款有没有异常增加？有没有出售应收账款？有没有推迟资本支出？
...
- [会计作为商业语言及其局限](/model/accounting-as-language-its-limits) — 利润vs现金流的分歧正是会计局限性的核心体现
- [复式记账法](/model/double-entry-bookkeeping) — 理解利润和现金流为何按不同规则计算的基础
- [安全边际](/model/margin-of-safety) — 现金流分析帮助你估算企业的真实价值，安全边际保护你免受估算误差的伤害
- [护城河（Moat）](/model/moat) — 真正有护城河的企业通常拥有强劲且持续的自由现金流
- [复利效应](/model/compound-interest) — 能产生高自由现金流的企业，其复利效应更为真实和持久
- [激励机制](/model/incentives-economic-view) — 管理层有强烈动机美化利润（奖金、股价），而现金流更难被激励机制扭曲
- [逆向思维](/model/inversion) — 检验财务数据的最佳方式：如果这个利润数字是假的，我怎么能发现？答案通常在现金流里
