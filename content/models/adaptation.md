...
sourceUrl: "https://mungermodels.com/models/adaptation"
---
...
更深层的问题是文化上的。2008年诺基亚内部一份被泄露的备忘录显示，中层管理人员普遍害怕向高层传递坏消息。因为诺基亚过去太成功了，“我们需要根本性改变”这种信息被组织的免疫系统排斥——就像一个身体健康的人排斥“你可能生了重病”的诊断一样。芒格描述的[避免不一致性倾向](/model/inconsistency-avoidance-tendency)在这里展现得淋漓尽致。
...
这个概念在进化生物学中有一个著名的比喻——[红皇后效应](/model/red-queen-effect)（Red Queen Effect），出自刘易斯·卡罗尔的《爱丽丝镜中奇遇记》。红皇后对爱丽丝说：“在这里，你必须不停地奔跑，才能留在同一个地方。”
...
反面案例同样说明问题。百视达（Blockbuster）不是不知道流媒体是趋势——它在2004年就推出了在线租赁服务。但它的适应速度太慢了，慢到Netflix已经建立起[规模优势](/model/economies-of-scale)时，百视达的线上业务还在和自家的线下门店争夺内部资源。诺基亚不是不知道智能手机是未来——但它把宝贵的三年时间浪费在了内部软件平台的争吵上。
...
4. **不要用“忠诚”来抗拒适应**：很多管理者对过去成功的战略有一种情感上的依恋——“这是我们的DNA”、“这是让我们走到今天的东西”。这种[避免不一致性倾向](/model/inconsistency-avoidance-tendency)在稳定环境中是美德，在剧变环境中是死刑。达尔文会告诉你：恐龙也有DNA，而且运作了一亿六千万年——直到它不再运作的那一天。
...
芒格终其一生都在实践这种适应性：他的核心原则——多学科思维、逆向思考、[能力圈](/model/circle-of-competence)——几十年不变。但他思考的具体领域、投资的具体标的、对世界的具体判断，一直在根据新信息而调整。他九十多岁时依然在学习新东西、修正旧观点。
...
- [进化论](/model/modern-darwinian-synthesis) — 适应性是进化的核心输出，理解适应性需要理解自然选择
- [生态系统思维](/model/ecosystem-thinking) — 适应总是相对于特定生态系统而言的
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 组织和个人抗拒改变的心理根源，适应性的最大敌人
- [护城河（Moat）](/model/moat) — 护城河和适应性的关系：护城河需要不断适应才能维持
- [能力圈](/model/circle-of-competence) — 知道自己的核心能力边界，是有效适应的前提
- [竞争性毁灭](/model/competitive-destruction) — 适应性不足时的终极后果
- [红皇后效应](/model/red-queen-effect) — 适应不是一次性的，而是持续性的军备竞赛
- [沉没成本谬误](/model/sunk-cost-fallacy) — 对已有投资的依恋阻碍适应的常见机制
- [逆向思维](/model/inversion) — 问“什么会杀死我们”是发现适应性盲点的最有效工具
- [表观遗传学](/model/epigenetics) — 表观遗传允许生物体在不改变基因序列的情况下快速适应环境变化
