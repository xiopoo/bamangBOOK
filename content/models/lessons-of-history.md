...
sourceUrl: "https://mungermodels.com/models/lessons-of-history"
---
...
芒格把历史当作一个庞大的案例数据库。每一次泡沫都是[过度乐观倾向](/model/overoptimism-tendency)和[社会认同倾向](/model/social-proof-tendency)的案例研究。每一个帝国的衰落都是制度僵化和[避免不一致性倾向](/model/inconsistency-avoidance-tendency)的样本。每一个伟人的崛起都是[复利效应](/model/compound-interest)在能力建设上的演示。当你积累了足够多的历史案例，你就能看到那些穿越时间的不变模式——而那些不变的模式，才是真正有用的知识。
...
芒格自己就是传记阅读的直接受益者。他反复提到[富兰克林的自我修炼](/model/franklins-self-improvement-system)对他人生哲学的深刻影响。他对企业分析的很多洞见来自对洛克菲勒、卡内基等商业巨头传记的研究。他对人性的理解很大程度上来自对历史人物在极端情况下行为的观察。可以说，芒格的多元思维模型体系本身就是几十年传记阅读的结晶。
...
**参与者的心理模式完全相同。** 两次泡沫中，你都能看到这样的心理演变：最初是少数精明投资者的理性押注 -> 然后是更多人看到早期参与者赚了钱开始跟风（[社会认同倾向](/model/social-proof-tendency)） -> 然后是全民参与、连完全不懂投资的人都在买入（[艳羡与妒忌倾向](/model/envy-jealousy-tendency)） -> 然后是理性的声音被淹没、任何警告都被视为“不懂新范式”（[避免怀疑倾向](/model/doubt-avoidance-tendency)） -> 最后是某个触发事件导致信心崩塌，恐慌性抛售。
...
**第二个陷阱：[幸存者偏差](/model/survivorship-bias)。** 历史记录本身就有严重的选择偏差。我们读到的是成功者的传记、获胜国家的叙事、流传下来的文献。无数失败者的故事、输家的视角、被毁灭的文明的知识，都随着时间消失了。如果你只从幸存者的历史中学习，你会系统性地高估成功的概率、低估风险的严重性。芒格对此有清醒的认识，这也是他同时重视[逆向思维](/model/inversion)的原因——不只研究什么导致了成功，更要研究什么导致了失败。
...
2. **建立自己的“历史案例库”。** 每次阅读到一个有趣的历史事件，把它归类到一个心智模型下面。泡沫案例、制度失败案例、技术颠覆案例、领导力案例——随着案例库的扩大，你识别模式的能力会越来越强。这就是知识的[复利效应](/model/compound-interest)在历史领域的体现。
...
在芒格的认知框架里，历史是所有思维模型的测试场。你学了[概率思维与期望值](/model/probabilistic-thinking-expected-value)，历史给你几千个真实案例来验证和校准你的概率判断。你学了[社会认同倾向](/model/social-proof-tendency)，历史给你从宗教运动到金融泡沫的无数实例来理解从众的力量。你学了[安全边际](/model/margin-of-safety)，历史告诉你那些没有留足安全边际的人最终的下场。每一个思维模型都是一把工具，历史则是你磨砺这些工具的砂轮。
...
- [复利效应](/model/compound-interest) — 历史知识的积累遵循复利曲线，案例越多，模式识别能力越强
- [社会认同倾向](/model/social-proof-tendency) — 历史上每次泡沫的核心驱动力之一
- [过度乐观倾向](/model/overoptimism-tendency) — “这次不一样”背后的心理机制
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 历史提供了校准概率判断的大量样本
- [安全边际](/model/margin-of-safety) — 历史告诉我们为什么必须为意外预留空间
- [逆向思维](/model/inversion) — 从失败的历史中学习，比从成功的历史中学习更有价值
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 帝国衰落和企业僵化的深层心理原因
- [富兰克林的自我修炼](/model/franklins-self-improvement-system) — 芒格最重要的传记阅读对象之一
- [斯多葛主义](/model/stoicism) — 历史哲学中与以史为鉴互补的思维框架
