...
scenarios:
  - "学习、复盘与认知提升"
description: "达尔文养成铁律：遇到与理论矛盾的事实必须立即记录，因为大脑会自动遗忘不利证据。芒格从中提取出一种对自身思维过程的深刻不信任和系统性自我纠偏方法。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/darwinian-objectivity"
---
...
**主动寻找反对者。** 达尔文不回避那些可能反对他的人。他和地质学家亚当·塞奇威克通信——塞奇威克后来成了[进化论](/model/modern-darwinian-synthesis)最激烈的批评者之一。他和植物学家约瑟夫·胡克反复辩论。他甚至在《物种起源》中专门用了一整章来讨论“对自然选择理论的困难”——主动列出自己理论的弱点，然后尽力回应。这种做法在当时是极为罕见的，在今天依然是极为罕见的。大多数作者只会在自己的书中用最小的篇幅、最轻描淡写的方式提及反面论点，然后迅速驳回。达尔文是认真地、详尽地、诚实地展示反面论点的全部力量，然后才尝试回应。
...
- [逆向思维](/model/inversion) — 达尔文式客观态度的核心操作就是逆向思维：主动寻找反面证据
- [双轨分析](/model/adversarial-system) — 达尔文的方法是[双轨分析](/model/two-track-analysis)的典范：第一轨道形成假说，第二轨道检验心理偏差
- [避免意识形态偏见](/model/avoiding-ideology) — 意识形态是第一结论偏见最极端的形式，达尔文式态度是其天然解药
- [检查清单方法](/model/checklist-method) — 达尔文的“反面证据笔记本”本质上是一种专门针对确认偏误的检查清单
- [避免怀疑倾向](/model/doubt-avoidance-tendency) — 人类天生倾向于消除怀疑、锁定结论，达尔文式态度要求你抵抗这种倾向
- [知识谦逊](/model/intellectual-humility) — 达尔文式客观态度的前提是承认自己可能是错的，这正是知识谦逊的核心
