...
sourceUrl: "https://mungermodels.com/models/arithmetic-expected-value"
---
...
也就是说，**你每押1元钱，期望亏损5.3分。** 无论你怎么下注、何时下注、押什么号码，只要你一直玩下去，你平均每下注1元就会亏损5.3分。赌场不需要每把都赢。它只需要确保每把的期望值是正的——然后让[大数定律](/model/law-of-large-numbers)完成剩下的工作。
...
芒格最喜欢用赛马来解释期望值。在他著名的“[彩池投注系统](/model/pari-mutuel-system)”演讲中，他展开了一个精彩的类比：
...
芒格用这个类比直接连接到了股市投资。股市就像一个巨大的赛马场——大多数时候，股票的定价大致反映了它们的[内在价值](/model/intrinsic-value)，期望值接近零或微弱为正（扣除[交易成本](/model/transaction-costs)后甚至为负）。但偶尔，某些股票会被严重错误定价——市场因为恐慌或忽视而给出了远低于内在价值的价格。在这些时刻，期望值显著为正。

芒格的投资策略可以概括为：**大多数时候不下注，只在期望值显著为正时下大注。**

这就是他说的“少下注、下大注”（[少下注下大注](/model/bet-seldom-bet-big)）的数学基础。如果你只在期望值显著为正的时候行动，而且你的概率估计大致正确，那么长期下来，你几乎不可能亏钱——就像赌场几乎不可能亏钱一样。
...
**第三，期望值忽视了分布的形状。** 两个投资可能有相同的期望值，但风险完全不同。投资A确定给你10%回报。投资B有50%概率给你30%回报，50%概率亏10%。两者的期望值都是10%。但大多数理性的人会选择投资A——因为确定性有价值。这就是为什么期望值需要和[不对称性与凸性](/model/asymmetry-convexity)、[安全边际](/model/margin-of-safety)等其他工具配合使用。
...
2. **关注下行情景的幅度。** 即使期望值为正，如果下行情景意味着永久性亏损超过50%，你需要特别谨慎。芒格的原则是：任何可能导致永久性巨额亏损的投资，无论期望值多高，都需要更大的[安全边际](/model/margin-of-safety)。
...
> “生活就是一系列的[机会成本](/model/opportunity-cost)。你必须把你的资金投入到期望值最高的地方。”
...
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 期望值的概念基础，强调概率思维在决策中的核心作用
- [少下注下大注](/model/bet-seldom-bet-big) — 芒格将期望值思维转化为投资策略的核心表达
- [彩池投注系统](/model/pari-mutuel-system) — 芒格最常用的期望值类比，将股市比作赛马场
- [安全边际](/model/margin-of-safety) — 期望值为正是必要条件，安全边际提供额外的缓冲
- [不对称性与凸性](/model/asymmetry-convexity) — 不对称回报结构下期望值的特殊分析
- [大数定律](/model/law-of-large-numbers) — 期望值在长期中兑现的数学保证
- [基本算术与数量级估算](/model/basic-arithmetic-order-of-magnitude-estimation) — 期望值计算的基础工具
- [复利效应](/model/compound-interest) — 正期望值通过复利产生长期的巨大财富
