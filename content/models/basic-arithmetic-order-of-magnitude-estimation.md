...
sourceUrl: "https://mungermodels.com/models/basic-arithmetic-order-of-magnitude-estimation"
---
...
芒格要强调的不是你会不会算，而是你在做重大决策时，有没有**习惯性地动手算一算**。
...
**第二个陷阱：忽略基础比率。** 费米估算的一个核心步骤是选择合理的“锚点”或基础比率。如果你的锚点就错了，后续再精妙的推理也救不了你。比如你估计“中国有10%的家庭养猫”，如果这个基础比率偏差了5倍（实际是2%），你所有基于此的计算都会偏差5倍。这就是为什么芒格强调[条件概率与基础比率](/model/conditional-probability-base-rates)——在做任何估算之前，先确保你的起点是对的。
...
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 期望值计算是基本算术在决策中的核心应用
- [复利效应](/model/compound-interest) — 复利是基本算术中指数运算的直接体现，72法则是心算捷径
- [条件概率与基础比率](/model/conditional-probability-base-rates) — 费米估算的关键步骤依赖于合理的基础比率选择
- [安全边际](/model/margin-of-safety) — 安全边际的计算本身就是一道简单的减法和除法题
- [逆向思维](/model/inversion) — 反过来算：这个项目需要什么条件才能不亏钱？
- [乘法系统思维](/model/multiplicative-systems) — 连锁概率相乘，任一环节失败都会导致整体失败
- [决策树理论](/model/decision-tree-theory) — 决策树是费米估算的结构化版本
