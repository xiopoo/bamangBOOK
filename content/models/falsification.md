...
scenarios:
  - "学习、复盘与认知提升"
description: "再多白天鹅也不能证明所有天鹅都是白色的，但一只黑天鹅就够了。否证性证据的信息价值远大于确认性证据，芒格要求对最钟爱的观点最严格地审视。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/falsification"
---
...
- [达尔文式客观态度](/model/darwinian-objectivity) — 达尔文的反面证据笔记本是否证思维最经典的实践范例
- [逆向思维](/model/inversion) — 逆向思维问“什么会让我失败”，否证思维更进一步：指定“什么能证明我是错的”
- [双轨分析](/model/adversarial-system) — 否证思维是[双轨分析](/model/two-track-analysis)第二轨道的核心引擎：检验第一轨道形成的判断
- [避免意识形态偏见](/model/avoiding-ideology) — 意识形态的本质特征正是“不可证伪”，否证思维是其天然解药
- [检查清单方法](/model/checklist-method) — 否证条件清单（“死亡条件”清单）是检查清单方法的高级应用
- [安全边际](/model/margin-of-safety) — 安全边际本质上是对否证风险的数量化缓冲
- [能力圈](/model/circle-of-competence) — 有效的否证需要领域知识支撑，否则你不知道该否证什么
