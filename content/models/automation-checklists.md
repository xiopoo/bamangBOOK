...
sourceUrl: "https://mungermodels.com/models/automation-checklists"
---
...
事故调查的结论令人震惊：不是机械故障，不是设计缺陷，而是**飞行员忘记释放一个控制锁**。Model 299比以往任何飞机都复杂得多——四台引擎、可收放起落架、新型襟翼系统、变距螺旋桨——需要飞行员在起飞前完成的步骤多到超出了人类记忆力的可靠范围。一位报纸记者写道：“这架飞机太复杂了，一个人飞不了。”
...
心理学给出了大量答案——[避免不一致性倾向](/model/inconsistency-avoidance-tendency)、[错误衡量易得性倾向](/model/availability-misweighing-tendency)、过度自信、注意力遗漏。但工程学提供了一个更直接、更实用的框架来理解这个问题：**人类大脑不是为高可靠性重复执行而设计的。**
...
芒格对检查清单的推崇不是泛泛而谈。他把[检查清单方法](/model/checklist-method)论直接嵌入了自己的投资决策流程。
...
**第一张清单：投资分析清单。** 在考虑任何投资之前，系统性地检查一系列关键问题：这个企业有没有持久的竞争优势？管理层是否诚实且有能力？当前价格是否提供了足够的[安全边际](/model/margin-of-safety)？这个行业的长期前景如何？最坏的情况下会损失多少？这张清单确保他不会因为对某个方面的兴奋而忽略了其他关键维度的分析。

**第二张清单：心理偏误清单。** 这是芒格的独创。在做完分析之后，他会拿出第二张清单，逐一检查自己是否受到了某种心理偏误的影响。我是不是因为[避免不一致性倾向](/model/inconsistency-avoidance-tendency)而只看到了支持买入的证据？我是不是因为[社会认同倾向](/model/social-proof-tendency)而被其他聪明投资者的热情所感染？我是不是因为[锚定偏差](/model/anchoring-bias)而被最近的价格走势影响了判断？我是不是因为[错误衡量易得性倾向](/model/availability-misweighing-tendency)而过度关注了最近的新闻？
...
芒格的思维模型体系中有许多深奥的概念——热力学第二定律、达尔文[进化论](/model/modern-darwinian-synthesis)、[复杂适应系统](/model/complex-adaptive-systems)。但如果你问他哪个工具的实用性最高、投入产出比最惊人，答案可能出乎意料地朴素：一张清单。
...
在一个痴迷于创新、颠覆、十倍增长的时代，“用一张纸来避免犯错”这种建议显得太过平凡。但平凡的工具，持续地使用，产生的[复利效应](/model/compound-interest)，往往超过任何花哨的策略。这就是检查清单的终极教训，也是工程学送给所有决策者的礼物：**承认人类的局限，然后用系统来弥补它。**
...
- [容错设计与优雅降级](/model/fault-tolerance) — 检查清单是最低成本的容错机制
- [逆向思维](/model/inversion) — 检查清单体现了“先想怎么会失败”的逆向思考
- [简单化在商业中的应用](/model/simplicity-in-business) — 好的检查清单必须简短，体现简单化原则
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 芒格心理偏误清单的首要检查对象
- [冗余备份系统](/model/redundancy) — 检查清单为人类判断提供了一层冗余保护
- [故障模式分析](/model/failure-mode-analysis) — 检查清单的设计应基于对故障模式的系统分析
