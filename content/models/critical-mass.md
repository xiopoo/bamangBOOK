...
sourceUrl: "https://mungermodels.com/models/critical-mass"
---
...
但马克·扎克伯格做了一件关键的事：他限制了早期用户的范围。先是只有哈佛，然后逐个大学开放。这相当于什么？相当于**改变了材料的形状**。他没有把有限的用户分散到全世界（一块又长又细的铀棒，中子全从表面逃逸了），而是把它们压缩在一个极小的空间里（一个球形的铀块，中子无处可逃，必然击中下一个原子）。在哈佛内部，用户密度高到一个临界点——你的朋友都在上面，你不在上面就社交脱节——于是链式反应启动了。
...
**电话网络。** 当只有10个人有电话时，电话几乎没有用。当1000个人有电话时，有点用但不够。当100万人有电话时，没有电话就意味着与世隔绝。这就是经济学家所说的“[网络效应](/model/network-effects)”——但用临界质量的框架来理解更精确：网络效应不是线性增长的，它有一个引爆点。在引爆点之前，增长缓慢甚至可能停滞；在引爆点之后，增长变成自我加速的链式反应。
...
- [复利效应](/model/compound-interest) — 复利是时间维度上的积累，临界质量是积累达到阈值后的质变
- [反馈环](/model/feedback-loops) — 临界质量跨越后触发的正反馈循环是“爆发”的机制
- [自我催化模型](/model/autocatalysis) — 自催化反应达到临界浓度后自我加速，与临界质量直接关联
- [飞轮效应](/model/flywheel-effect) — 飞轮转速达到临界后自我维持，是临界质量在商业系统中的表现
- [网络效应](/model/network-effects) — 网络效应是产生临界质量现象的最常见底层机制
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 判断系统是否会达到临界质量本质上是概率判断
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多种力量同时达到临界状态时产生的超级效应
