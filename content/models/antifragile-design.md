...
sourceUrl: "https://mungermodels.com/models/antifragile-design"
---
...
芒格说这笔投资“比高盛那笔还好”——因为它不仅在买入时就提供了极高的[安全边际](/model/margin-of-safety)和股息回报，而且随着时间推移，这些企业的反脆弱特质持续在各种冲击（能源危机、通胀、地缘政治波动）中得到验证，估值也在持续修复。

反脆弱投资的关键不是预测危机何时来——没有人能做到这一点——而是**在危机来临之前就构建好一个结构，使得危机本身成为你的盟友而非敌人。**
...
- [脆弱性与反脆弱性](/model/fragility-antifragility) — 本模型是从工程设计角度对反脆弱概念的实践运用
- [冗余备份系统](/model/redundancy) — 冗余是反脆弱的基础：没有冗余就没有在冲击中行动的余力
- [安全边际](/model/margin-of-safety) — 安全边际确保下行风险可控，这是反脆弱的前提条件
- [不对称性与凸性](/model/asymmetry-convexity) — 反脆弱系统的数学特征：有限的下行，无限的上行
- [容错设计与优雅降级](/model/fault-tolerance) — 容错是坚韧级别的设计，反脆弱是更高层次的追求
- [进化论](/model/modern-darwinian-synthesis) — 生物进化是自然界最宏大的反脆弱系统：物种通过环境压力不断适应和进化
- [逆向思维](/model/inversion) — 反脆弱设计的起点是逆向思考：“危机来临时，我如何从中获益？”
- [风险优先](/model/risk-first) — 反脆弱的前提是生存优先，下行风险必须被严格控制
