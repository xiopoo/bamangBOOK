...
sourceUrl: "https://mungermodels.com/models/economies-of-scale"
---
...
**第二个问题：服务行业的规模天花板。** 芒格指出，并非所有行业都能享受规模优势。尤其是那些高度依赖个人判断和本地知识的服务行业——律所、咨询公司、医疗机构——规模扩张到一定程度后，[质量控制](/model/quality-control)就变成一场噩梦。这也是为什么世界上最大的律所和最好的律所往往不是同一家。
...
- [护城河（Moat）](/model/moat) — 规模优势是五种经典护城河来源之一
- [竞争性毁灭](/model/competitive-destruction) — 规模优势可以被完全不同维度的技术创新绕过
- [飞轮效应](/model/flywheel-effect) — 规模优势的自我加强机制：规模→低成本→更多客户→更大规模
- [激励机制](/model/incentives-economic-view) — 理解企业为何追求规模（或为何不追求）
- [临界质量](/model/critical-mass) — 许多规模优势只有在达到某个门槛后才会显现
- [复利效应](/model/compound-interest) — 规模优势随时间的非线性积累
- [逆向思维](/model/inversion) — 反过来问：什么情况下规模是劣势？
- [能力圈](/model/circle-of-competence) — 判断规模优势的前提是你理解这个行业的成本结构
