...
sourceUrl: "https://mungermodels.com/models/separation-of-powers"
---
...
> “给我看[激励机制](/model/incentives-economic-view)，我就能告诉你结果。”
...
如果仅仅是“分开”，这套设计还远远不够。建国者们的真正天才在于**制衡**（Checks and Balances）——他们让每个分支都拥有制约其他分支的工具。
...
阿克顿勋爵那句著名的话——“权力导致腐败，绝对权力导致绝对腐败”——不是一句道德劝诫，而是一个经验性的观察。芒格从心理学的角度理解这一点：不受制约的权力会激活一系列心理偏误——[自视过高的倾向](/model/excessive-self-regard-tendency)让掌权者高估自己的判断，[权威错误影响倾向](/model/authority-misinfluence-tendency)让下属放弃质疑，[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)让掌权者的决策越来越多地服务于维护自身权力。当这些偏误叠加在一起，灾难只是时间问题。
...
芒格在多个场合引用安然作为反面教材。他指出，安然的问题不只是几个高管的道德败坏——真正的问题是**所有的制衡机制同时失效了**。董事会、审计师、分析师、监管机构——每一道防线都被突破了。为什么？因为它们都面临着同一个结构性问题：本应独立行使制衡功能的机构，与被制衡的对象有着太深的利益关联。
...
**双头决策的制衡。** 芒格和巴菲特之间的关系本身就是一种制衡机制。两个[独立思考](/model/independence)的人共同做出重大决策——任何一个人的判断失误都有另一个人来纠正。巴菲特公开说过，芒格否决了他若干笔他原本很想做的投资，事后证明芒格是对的。这不是一个形式上的“双签制度”——那在很多公司沦为了走过场——而是两个有能力、有独立判断、且彼此尊重的大脑之间的真实对抗。
...
**个人层面的“权力制衡”同样重要。** 芒格把制衡思维延伸到了个人决策领域。他的[检查清单方法](/model/checklist-method)本质上就是一种个人的制衡机制——它迫使你在做决策之前系统性地审视可能的盲点。他的[双轨分析](/model/adversarial-system)也是如此——一条轨道分析理性因素，另一条轨道检查心理偏误，两条轨道相互制衡。你不能完全信任自己的理性分析（它可能被偏误扭曲），也不能完全依赖对偏误的检查（它可能让你过度怀疑），但两者的结合比单独使用任何一个都更可靠。
...
3. **在个人决策中建立“内部制衡”。** 使用[检查清单方法](/model/checklist-method)来对抗自己的盲点。使用[双轨分析](/model/adversarial-system)来让理性分析和偏误检查相互制衡。在重大决策前寻求一个“值得信赖的反对者”——不是一个会附和你的朋友，而是一个有能力和意愿来挑战你判断的人。
...
- [激励结构与代理问题](/model/incentive-structure-agency-problem) — 制衡失效的最常见原因是激励结构使制衡者与被制衡者利益一致
- [信托责任](/model/fiduciary-duty) — 制衡机制是确保受托人履行信托责任的制度保障
- [对抗制与辩证过程](/model/adversarial-system) — 对抗制是司法领域的制衡机制，通过双方对立来逼近真相
- [自视过高的倾向](/model/excessive-self-regard-tendency) — 不受制约的权力会加剧掌权者的自负
- [权威错误影响倾向](/model/authority-misinfluence-tendency) — 缺乏制衡时，下属对权威的盲从会放大权威的错误
- [社会认同倾向](/model/social-proof-tendency) — 组织中的“跟从领袖”文化会削弱内部制衡的有效性
- [奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency) — 利益关联是制衡机制被架空的核心原因
- [冗余备份系统](/model/redundancy) — 多重制衡就是治理领域的冗余设计：一道防线失败，还有下一道
- [检查清单方法](/model/checklist-method) — 检查清单是个人层面的“制衡制度”
...
- [ ] 我是否在重大决策前使用了检查清单和[双轨分析](/model/two-track-analysis)？
