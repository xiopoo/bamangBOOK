...
scenarios:
  - "学习、复盘与认知提升"
description: "把复杂问题简化到最基本的事实层面，然后从那里重新推理，而非依赖类比和惯例。马斯克用此方法将火箭成本降低了98%的行业溢价。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/first-principles-thinking"
---
...
这三步说起来简单，但在实践中几乎没有人这么做。原因有三个。第一，它需要你承认自己现有的认知可能全是从类比中继承来的，而不是从基本事实中推导出来的——这需要一种罕见的[知识谦逊](/model/intellectual-humility)。第二，它的计算成本极高——从零开始推理比套用现成模板要费力得多，大脑会本能地抗拒。第三，它的结论往往与“所有人都知道的东西”相矛盾，坚持这种结论需要面对巨大的社会压力。
...
2. **拆解到成本结构。** 任何产品或服务，追问它的真实成本构成。利润空间中有多少是来自真正的价值创造，有多少是来自[信息不对称](/model/asymmetric-information)或惯性？
...
3. **与[逆向思维](/model/inversion)结合使用。** 用第一性原理识别真正的约束条件，用逆向思维排查这些约束条件中哪些会导致灾难。两种方法联合使用的效果远超单独使用。
...
- [逆向思维](/model/inversion) — 第一性原理找到基本事实后，逆向思维检验这些事实是否指向你意想不到的结论
- [奥卡姆剃刀](/model/occams-razor) — 第一性原理的自然产物往往是更简单的解释，与奥卡姆剃刀殊途同归
- [能力圈](/model/circle-of-competence) — 正确识别第一性原理需要对该领域有深刻理解，否则会把假设误认为基本事实
- [跨学科思维](/model/multidisciplinary-approach) — 不同学科的第一性原理往往能互相验证和补充，多学科框架让第一性原理更可靠
- [避免意识形态偏见](/model/avoiding-ideology) — 意识形态是最容易被误认为“第一性原理”的假设
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — 只掌握一种类比框架的人永远无法进行真正的第一性原理思考
- [多元思维模型框架](/model/latticework-of-mental-models) — 多元模型的价值在于提供多个不同的基本原理视角来审视同一问题
- [地图不是疆域](/model/map-is-not-the-territory) — 第一性原理思维提醒你区分模型与现实：任何理论框架都只是地图，不是疆域本身
