...
sourceUrl: "https://mungermodels.com/models/moat"
---
...
- **[转换成本](/model/switching-costs)**：客户一旦使用，更换的代价高到让人不愿动弹。不只是合同锁定，更多是习惯、数据、学习曲线构成的隐性成本。
- **[网络效应](/model/network-effects)**：产品价值随用户增加而增加，形成正反馈循环。用户越多越有用，越有用用户越多。
- **成本优势**：结构性的低成本地位，让竞争对手在价格战中天然处于劣势。注意是“结构性”——靠地理、流程、规模等难以复制的因素实现。
- **规模经济**：当固定成本巨大而边际成本极低时，规模本身就是壁垒。新进入者在达到同等规模之前，成本永远高于在位者。

最后一个关键点：**最好的企业往往不只拥有一种护城河，而是多种护城河叠加。** Apple同时拥有品牌和转换成本；Costco同时拥有成本优势和规模经济。多重护城河的保护力不是简单相加，而是相互增强的乘数效应。芒格把这种多重力量同向作用的情况叫做[Lollapalooza倾向](/model/lollapalooza-tendency)。
...
芒格理解品牌护城河的精妙之处在于，他看到了品牌背后的**心理学机制**。人们买See's不是因为做了理性的价格比较，而是因为多种心理倾向同时在起作用：

[社会认同倾向](/model/social-proof-tendency)——“大家送礼都买See's，所以我也应该买”。当你看到别人都选See's，你会自然地认为这是正确的选择。

[避免不一致性倾向](/model/inconsistency-avoidance-tendency)——“我一直买See's，没有理由换”。人一旦形成了品牌偏好，维持这个偏好几乎不需要理由，但改变它需要强大的理由。

[受简单联想影响的倾向](/model/influence-from-mere-association-tendency)——“See's让我想起妈妈、想起圣诞节、想起甜蜜的回忆”。品牌不是一个标志，它是一团情感记忆的集合体。每一次愉快的购买体验都在加厚这层联想。
...
这个[飞轮效应](/model/flywheel-effect)一旦转起来，后来者几乎不可能追上。因为你要和Costco竞争，你就得以同样低的价格卖东西。但你没有Costco那么大的采购规模，你的进货成本比它高。你要么亏钱卖（不可持续），要么加价更多（没有吸引力）。
...
**护城河和心理学之间有一层深刻的联系。** 品牌之所以能锁定消费者，归根结底是因为人类大脑不是理性计算机。[社会认同倾向](/model/social-proof-tendency)让我们跟随大众选择，[避免不一致性倾向](/model/inconsistency-avoidance-tendency)让我们抗拒改变习惯，[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)让我们对已经拥有的东西格外执着。最强的品牌护城河，本质上是在消费者心智中建造的一座堡垒——它的砖块是情感、习惯和社会认同，而不是混凝土和钢铁。这就是为什么品牌护城河通常比技术护城河更持久：技术会过时，但人性几乎不变。
...
芒格晚年回顾一生的投资决策时，经常提到See's Candies。不是因为它是伯克希尔最赚钱的投资——以绝对金额来算，它远比不上后来对可口可乐和苹果的投资。而是因为它是芒格和巴菲特**思维方式转变**的起点。
...
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多重护城河叠加产生的乘数效应
- [飞轮效应](/model/flywheel-effect) — 理解Costco等企业护城河如何自我加强
- [竞争性毁灭](/model/competitive-destruction) — 护城河面临的永恒威胁（熊彼特的创造性破坏）
- [社会认同倾向](/model/social-proof-tendency) — 品牌护城河的心理学基础之一
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 消费者忠诚度和转换成本的心理学基础
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 理解客户为何抗拒放弃已有的品牌
- [受简单联想影响的倾向](/model/influence-from-mere-association-tendency) — 品牌与情感记忆绑定的机制
- [反馈环](/model/feedback-loops) — 网络效应和规模经济的底层机制
- [能力圈](/model/circle-of-competence) — 分析护城河的前提是你真正理解这个行业
- [安全边际](/model/margin-of-safety) — 即使找到有护城河的好企业，也需要合理的价格
- [复利效应](/model/compound-interest) — 护城河让企业价值随时间呈指数级增长
- [逆向思维](/model/inversion) — 评估护城河时最有力的工具：什么会摧毁它？
...
- [ ] **逆向检验**：用[逆向思维](/model/inversion)问自己——什么因素会摧毁这条护城河？这些因素出现的概率有多大？
