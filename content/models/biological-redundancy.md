...
sourceUrl: "https://mungermodels.com/models/biological-redundancy"
---
...
芒格在谈论投资时反复强调的“[安全边际](/model/margin-of-safety)”概念，追溯到它的生物学根源，就是冗余设计。你买一座桥，设计承重是预期最大负载的三倍。你做一笔投资，要求[内在价值](/model/intrinsic-value)远超买入价格。你经营一家企业，保持的现金储备远超正常运营所需。这不是保守，这是三十亿年进化智慧的精髓——**在一个你无法预测所有风险的世界里，唯一理性的策略就是为未知的风险留出余量。**
...
- [安全边际](/model/margin-of-safety) — 冗余设计在投资中的直接应用
- [进化论](/model/modern-darwinian-synthesis) — 冗余是自然选择在不确定环境中的产物
- [免疫系统与抗脆弱性](/model/immune-system-antifragility) — 免疫系统的多层防线是冗余原则的体现
- [复杂适应系统](/model/complex-adaptive-systems) — [复杂系统](/model/complex-systems)中冗余是维持稳定性的关键机制
- [安全边际（工程源头）](/model/engineering-margin-of-safety) — 工程学中的安全系数与生物冗余的直接类比
- [风险优先](/model/risk-first) — 冗余是应对尾部风险的核心策略
- [护城河（Moat）](/model/moat) — 多重竞争优势构成的护城河本质上是商业冗余
...
- [ ] **[单点故障](/model/single-point-of-failure)排查**：系统中是否存在单点故障——一个环节的失效会导致整体崩溃？
