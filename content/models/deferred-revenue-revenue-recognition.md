...
scenarios:
  - "投资决策与资产评估"
  - "风险识别与系统韧性"
description: "收入确认决定企业何时把交易记成收入，一行规则就能制造或拆穿利润幻觉。从安然到瑞幸，理解收入质量是识破财务造假的第一道防线，也是巴菲特看年报的第一组数字。"
source: "mungermodels.com"
sourceUrl: "https://mungermodels.com/models/deferred-revenue-revenue-recognition"
---
...
这不仅仅是会计问题，而是一个[激励机制](/model/incentives-economic-view)问题叠加一个[权威错误影响倾向](/model/authority-misinfluence-tendency)问题。整个系统中的每一个参与者——管理层、审计师、分析师、投资者——都有理由相信收入数字是真实的，因为质疑这个数字对他们所有人都没有短期好处。
...
- [现金流量vs利润](/model/cash-flow-vs-earnings) — 收入确认操纵最终会在利润与现金流的背离中暴露出来
- [会计作为商业语言及其局限](/model/accounting-as-language-its-limits) — 收入确认的判断空间是会计语言固有局限性的核心体现
- [激励机制](/model/incentives-economic-view) — 管理层薪酬与收入增长挂钩是收入操纵的根本驱动力
- [审计与独立验证](/model/audit-independent-verification) — 审计师对收入确认政策的审查是防止操纵的制度性防线
- [表外负债与或有负债](/model/off-balance-sheet-contingent-liabilities) — 安然同时使用了收入操纵和表外实体，两种手法经常联合出现
- [护城河（Moat）](/model/moat) — 高质量的收入来自强大的护城河：客户愿意预付、持续续约、不轻易离开
- [逆向思维](/model/inversion) — 当收入增长故事太完美时，逆向追问：这些收入有多少已经变成了现金？
