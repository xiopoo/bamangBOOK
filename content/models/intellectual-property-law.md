...
sourceUrl: "https://mungermodels.com/models/intellectual-property-law"
---
...
- [品牌认同](/model/brand-power) — 商标法是品牌护城河的法律基石
- [护城河（Moat）](/model/moat) — 知识产权是构建竞争护城河的核心工具之一
- [专利权、商标权与特许经营权](/model/patents-trademarks-franchises) — 微观经济学视角下知识产权作为无形资产的分析
- [激励机制](/model/incentives-economic-view) — 知识产权法的本质是通过垄断权激励创新
- [规模效应与反效应](/model/scaling-effects-diseconomies-in-engineering) — 大企业在知识产权维护和执行方面具有[规模优势](/model/economies-of-scale)
- [路径依赖与锁定](/model/path-dependence-lock-in) — 早期建立的知识产权可以产生长期的路径锁定效应
- [竞争性毁灭](/model/competitive-destruction) — 知识产权保护与创造性破坏之间的张力
- [公地悲剧（法学视角）](/model/tragedy-of-the-commons) — 知识产权法防止知识创造沦为公地悲剧
