...
sourceUrl: "https://mungermodels.com/models/avoiding-ideology"
---
...
一旦你接受了一套意识形态，你就不再需要面对每个问题都[独立思考](/model/independence)的艰苦过程。你只需要把问题输入你的意识形态框架，答案就自动弹出。这是认知上的巨大节省——但也是认知上的彻底投降。
...
**市场原教旨主义者**相信自由市场能解决几乎所有问题。监管是邪恶的，税收是抢劫，政府干预必然导致效率损失。在这个框架内，任何市场失灵都被归因于“监管扭曲了市场信号”——解决方案永远是“更多自由，更少监管”。

**政府干预主义者**相信市场天然趋向不公平和不稳定。不受约束的资本主义必然导致垄断、不平等和周期性崩溃。在这个框架内，任何经济问题都被归因于“监管不够”——解决方案永远是“更多管制，更多再分配”。
...
新加坡的成功不是因为它找到了“正确的意识形态”，而是因为它拒绝了意识形态，转而以[实用主义](/model/pragmatism)和实证分析来面对每一个具体问题。
...
**信念与意识形态的区别。** 芒格有很多坚定的信念。他坚信复利的力量。他坚信[安全边际](/model/margin-of-safety)的重要性。他坚信诚实和正直的价值。他坚信[跨学科思维](/model/multidisciplinary-approach)的有效性。但这些是从证据中归纳出来的、可以被新证据修正的信念。意识形态则不同——它是一个封闭的、自我证实的系统，新证据被系统地过滤和重新解释以服务于预设结论。
...
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — 意识形态是最大的铁锤：一套理论声称能解释和解决一切问题
- [跨学科思维](/model/multidisciplinary-approach) — 跨学科思维是意识形态的天然解毒剂，多元视角防止任何单一框架的垄断
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 一旦接受了某种意识形态，人类天然的一致性需求会阻止你改变
- [避免怀疑倾向](/model/doubt-avoidance-tendency) — 意识形态提供虚假确定性，利用了人类对怀疑和不确定的厌恶
- [回馈倾向](/model/reciprocation-tendency) — 意识形态社群中的互惠强化：你认可我的观点，我就认可你的
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 意识形态的威力来自多种心理倾向的叠加：身份融合+确认偏差+社会认同+避免不一致性
- [安全边际](/model/margin-of-safety) — 对自己判断可能错误的承认，本身就是一种反意识形态的安全边际
