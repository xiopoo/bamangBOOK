...
sourceUrl: "https://mungermodels.com/models/limits-of-extrapolation-nonlinearity"
---
...
**三十五年。一整代人的时间。** 如果你在1989年买入日经指数，你需要等到2024年才能回本——还没算通货膨胀和[机会成本](/model/opportunity-cost)。
...
“条件会变化”——这四个字否定了线性外推的根本前提。线性外推假设驱动过去趋势的条件在未来保持不变。但在一个复杂的、[适应性](/model/adaptation)的系统中，这个假设几乎从来不是正确的。
...
华尔街最常用的估值工具之一是[现金流贴现法](/model/discounted-cash-flow)（Discounted Cash Flow, DCF）。它的基本逻辑是：一家公司的价值等于它未来所有现金流的现值之和。为了计算这个值，你需要对公司未来的增长率做出假设。
...
**阶段二：爆发式增长。** 一旦达到某个临界点（通常是10-15%的市场渗透率），增长突然加速。[网络效应](/model/network-effects)、口碑传播、基础设施成熟等因素形成正反馈循环。增长曲线变得极其陡峭。线性外推者在这个阶段会说：“这个东西将永远以这个速度增长！”
...
问题出在哪里？不在于这些事实是错的，而在于**人们把这些过去的事实线性外推到了未来，却没有考虑到让外推失效的非线性因素：**
...
**反直觉一：指数增长的早期看起来像不增长。** 如果某个东西每年翻倍，从1到2到4到8到16——在前几步看起来微不足道。但当它到达1024、2048、4096时，增长变得势不可挡。棋盘上放麦粒的古老故事就说明了这一点：前32格放的麦粒总共才约43亿粒，后32格需要的麦粒比全世界的产量还多。人类大脑天然低估指数增长的后期力量——芒格和巴菲特对[复利效应](/model/compound-interest)的极度重视，正是对这种认知偏差的刻意矫正。
...
**边界一：短期线性外推通常有效。** 明天的气温和今天差不多。下个月的销售额和这个月差不多。线性外推在短期、稳定的环境中是一种合理的近似。问题出在**把短期适用的线性外推不加修正地延伸到长期**。
...
**第四，关注系统中的非线性信号。** 债务水平的快速上升、信用质量的恶化、市场波动率的异常压缩——这些都是可能预示非线性转折的信号。它们不会告诉你转折点具体在哪一天，但它们会告诉你系统正在积累脆弱性。在这些信号出现时增加你的[安全边际](/model/margin-of-safety)和防御性配置。
...
他要求极大的[安全边际](/model/margin-of-safety)——因为他知道自己的预测可能因为非线性因素而大幅偏差。
...
- **[复利效应](/model/compound-interest)** — 复利本质上是指数增长，是线性外推最容易低估的力量
- **[回归均值](/model/regression-to-the-mean)** — 极端趋势终将逆转，这是对线性外推最直接的统计否定
- **[相变与临界现象](/model/phase-transitions)** — 系统在临界点附近的行为是高度非线性的
- **[反馈环](/model/feedback-loops)** — 正反馈驱动指数增长，负反馈驱动均值回归——两者都是非线性的
- **[护城河（Moat）](/model/moat)** — 芒格评估“趋势可否持续”的核心框架
- **[安全边际](/model/margin-of-safety)** — 非线性世界中对抗预测错误的最后防线
- **[现金流贴现法](/model/discounted-cash-flow)** — DCF的“永续增长”假设是线性外推陷阱的典型案例
- **[脆弱性与反脆弱性](/model/fragility-antifragility)** — 线性外推掩盖系统的脆弱性，非线性思维揭露它
...
- [ ] 如果趋势突然反转，我的损失能不能承受？我是否留了足够的[安全边际](/model/margin-of-safety)？
