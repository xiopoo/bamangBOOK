...
sourceUrl: "https://mungermodels.com/models/epigenetics"
---
...
一家企业的“基因组”——它的核心使命、价值主张、基本商业模式——可能在相当长的时间内保持不变。但企业的实际行为——它如何对待员工、如何服务客户、如何应对竞争——可以在“基因组”不变的情况下发生巨大变化。这种变化的驱动力就是组织的“表观遗传环境”：[激励机制](/model/incentives-economic-view)、绩效评估标准、管理层的行为示范、组织结构设计。
...
- [激励机制](/model/incentives-economic-view) — 表观遗传学在组织层面的直接对应：激励决定行为表达
- [进化论](/model/modern-darwinian-synthesis) — 表观遗传学是对经典进化论的重要补充
- [瓶颈效应与创始人效应](/model/bottleneck-effect-founder-effect) — 创始人效应设定“基因”，表观遗传决定“表达”
- [路径依赖与锁定](/model/path-dependence-lock-in) — 表观遗传标记可以跨代遗传，创造组织层面的路径依赖
- 文化演化 — 组织文化的传承和改变类似于表观遗传的调控和重编程
- [反馈环](/model/feedback-loops) — 表观遗传改变可以创造自我强化的反馈回路
- [奥卡姆剃刀](/model/occams-razor) — 改变“开关设定”往往比改变“底层代码”更简单有效
