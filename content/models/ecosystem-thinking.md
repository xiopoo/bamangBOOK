...
sourceUrl: "https://mungermodels.com/models/ecosystem-thinking"
---
...
这句话看起来像是常识，但它的深度远超表面。它在说的是：商业成功的关键不在于“变得更好”（那是线性思维），而在于**找到一个你能主导的、别人不想或不能跟你正面竞争的独特位置**（那是生态位思维）。
...
在自然界，有些生态系统支持大量物种共存（比如热带雨林），有些则被极少数物种主导（比如北极苔原）。差异在哪里？关键变量是**环境的多样性和资源的分布方式**。
...
- [进化论](/model/modern-darwinian-synthesis) — 生态系统是进化发生的“舞台”，理解进化需要理解生态系统
- [适应性](/model/adaptation) — 生态位的选择本质上是一种适应策略
- [护城河（Moat）](/model/moat) — 生态位优势是护城河的一种重要形式
- [飞轮效应](/model/flywheel-effect) — 生态系统中的正反馈循环与飞轮效应同构
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 生态系统中多种力量同向作用时的爆发效应
- [能力圈](/model/circle-of-competence) — 找到你的生态位，就是找到你的能力圈
- [网络效应](/model/network-effects) — 生态系统价值增长的核心驱动力之一
- [规模优势](/model/economies-of-scale) — 生态系统主导者通常享有规模优势
- [竞争性毁灭](/model/competitive-destruction) — 当新的生态系统取代旧的生态系统时发生
