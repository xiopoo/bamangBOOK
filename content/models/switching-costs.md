...
sourceUrl: "https://mungermodels.com/models/switching-costs"
---
...
你已经习惯了这个App的操作逻辑。你知道转账按钮在哪里，你知道怎么查电子账单，你闭着眼睛都能完成操作。换一个银行，你就得重新学习一套新界面。这是**学习成本**。

你和客户经理可能已经建立了某种关系。你需要贷款时他能帮你加速审批。你有问题时知道该找谁。换一家银行，你就是从零开始的陌生人。这是**关系成本**。

你心里还有一种模糊的不安：万一新银行还不如现在这个呢？至少现在这个的问题我都知道了，那些是“已知的不满”。新银行的问题我还不知道，那是“未知的风险”。这是[避免怀疑倾向](/model/doubt-avoidance-tendency)和[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)联手制造的心理成本。
...
银行账户的例子就属于这一层。每一件事单独来看都不难，但加在一起就让人望而却步。这是一种**死于一千次小切割**的效应——不是任何单一成本阻止了你，而是所有小成本的总和压垮了你的行动意愿。
...
芒格在分析这种成本时会引用[避免不一致性倾向](/model/inconsistency-avoidance-tendency)：人一旦学会了某种做事方式，就会强烈抗拒改变。这不是理性计算的结果，而是大脑为了节省认知资源而产生的本能反应。改变意味着不确定性，而大脑厌恶不确定性。
...
芒格理解这种锁定的心理学深度。人们对苹果产品的忠诚度不仅仅是理性计算的结果。[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)让你对即将失去的东西（无缝生态体验、多年的照片库、所有设备的协同）感到强烈的痛苦。[避免不一致性倾向](/model/inconsistency-avoidance-tendency)让你维持“我是苹果用户”这个自我认同。[社会认同倾向](/model/social-proof-tendency)让你看到周围的人都用苹果而更加确信自己的选择。
...
5. **与[网络效应](/model/network-effects)叠加的企业最强**：单纯的转换成本是防御性的——阻止客户离开。但如果转换成本与网络效应结合（微信），客户不仅走不了，而且越用越离不开，这才是最深的护城河。
...
3. **让客户的投资可见**：当客户能清楚地看到自己在你的平台上积累的价值（数据、内容、关系、工作成果），他们对离开的心理抗拒会更强。这是[被剥夺超级反应倾向](/model/deprival-superreaction-tendency)的巧妙应用。
...
- [护城河（Moat）](/model/moat) — 转换成本是五种护城河类型之一，也是最持久的一种
- [网络效应](/model/network-effects) — 网络效应与转换成本叠加形成最强锁定
- [飞轮效应](/model/flywheel-effect) — 转换成本使飞轮的每一圈都更难被打断
- [避免不一致性倾向](/model/inconsistency-avoidance-tendency) — 人们抗拒改变习惯的心理学基础，转换成本的核心驱动力之一
- [被剥夺超级反应倾向](/model/deprival-superreaction-tendency) — 人们对失去已有东西的痛苦远大于获得新东西的快乐
- [避免怀疑倾向](/model/doubt-avoidance-tendency) — 面对切换的不确定性，人们倾向于维持现状
- [Lollapalooza倾向](/model/lollapalooza-tendency) — 多重转换成本叠加产生的超级锁定效应
- [复利效应](/model/compound-interest) — 转换成本随使用时间累积增长，类似复利的指数积累
- [安全边际](/model/margin-of-safety) — 高转换成本企业也需要合理的买入价格
