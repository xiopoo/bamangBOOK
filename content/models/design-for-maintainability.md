...
sourceUrl: "https://mungermodels.com/models/design-for-maintainability"
---
...
**第四个边界：不是所有“难维护”都是设计问题。** 有些系统天生就复杂，其复杂性反映了问题本身的内在复杂性，而不是设计的失败。人体是一个极其难以“维护”的系统——但这不是因为上帝的设计水平差，而是因为生命本身就是一个不可简化的[复杂系统](/model/complex-systems)。在投资中也一样：有些企业的高维护成本是行业性质决定的（比如半导体制造），简单地排斥它们可能让你错过重大机会。
...
3. **寻找“自我维护”型护城河。** [品牌认同](/model/brand-power)、[网络效应](/model/network-effects)、[规模效应与反效应](/model/scaling-effects-diseconomies-in-engineering)——这些护城河的美妙之处在于它们在一定程度上能“自我维护”。品牌一旦建立，只需适度投入就能维持。网络效应一旦达到临界规模，每增加一个用户都自动强化护城河。
...
- [容错设计与优雅降级](/model/fault-tolerance) — 可维护性是容错能力的前提：不可维护的系统一旦降级就难以恢复
- [单点故障](/model/single-point-of-failure) — 可维护性设计通过模块化来减少单点故障的影响
- [简单化在商业中的应用](/model/simplicity-in-business) — 简单的系统天然具有更好的可维护性
- [自动化与检查清单](/model/automation-checklists) — 检查清单是降低维护门槛的标准工具
- [规模效应与反效应](/model/scaling-effects-diseconomies-in-engineering) — 大规模系统的可维护性挑战与规模效应的关系
- [能力圈](/model/circle-of-competence) — 选择自己能够理解和“维护”的投资对象
