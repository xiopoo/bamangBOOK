...
sourceUrl: "https://mungermodels.com/models/complex-adaptive-systems"
---
...
结果是什么？一个没有任何人设计、没有任何人控制、但每天都大致“管用”的交通系统。它不完美——有拥堵、有事故、有混乱。但它也不崩溃——两千万人最终都到达了目的地。而且，这个系统会“学习”：下雨天的流量分布和晴天不同，节假日和工作日不同。没有人下达命令，但系统整体表现出了[适应性](/model/adaptation)。
...
物理学家杰弗里·韦斯特（Geoffrey West）在圣塔菲研究所的研究发现了城市中一个令人惊叹的规律：城市的许多指标与人口之间存在超线性缩放关系。一个城市的人口翻倍时，其人均收入、专利数量、餐厅数量大约增长115%——而不是100%。城市越大，每个人的生产力越高。这不是因为大城市的人更聪明或更勤奋，而是因为更大的城市创造了更密集的交互网络——更多的偶遇、更多的信息交换、更多的跨界合作——这些交互的增加产生了[涌现性](/model/emergence)的生产力提升。
...
芒格在 2003 年 UCSB 经济学演讲中描述了社会科学中最危险的思维陷阱："**[物理学妒忌](/model/physics-envy)**"（physics envy）——**对一种不可得的精确度的渴求**。他反对的不是数学本身，而是把适用于简单系统的精确性期望，强行套在像经济学这样内在复杂的社会系统上。
...
芒格对此的实践回应是：**不追求精确预测，而是追求对系统特性的定性理解。** 他不试图预测明年的股价，而是试图理解一家企业所处的竞争生态是否有利于它长期生存。他不用复杂的模型来计算“精确的[内在价值](/model/intrinsic-value)”，而是用简单的标准来判断“这是否明显便宜”。他用[安全边际](/model/margin-of-safety)来对冲不可避免的预测误差。
...
- [涌现性](/model/emergence) — 复杂适应系统最核心的属性：整体大于部分之和
- [进化论](/model/modern-darwinian-synthesis) — 自然选择是生物界最基本的复杂适应系统动力机制
- [反馈环](/model/feedback-loops) — 正反馈和负反馈循环是复杂适应系统的核心运作方式
- [生态系统思维](/model/ecosystem-thinking) — 生态系统是复杂适应系统的典型实例
- [红皇后效应](/model/red-queen-effect) — 复杂适应系统中参与者相互适应的动态表现
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — “物理学妒忌”就是铁锤人倾向在学科层面的表现
- [概率思维与期望值](/model/probabilistic-thinking-expected-value) — 面对复杂适应系统时，概率思维比确定性思维更有效
- [安全边际](/model/margin-of-safety) — 在不可精确预测的系统中，安全边际是唯一可靠的保护
