...
sourceUrl: "https://mungermodels.com/models/map-is-not-the-territory"
---
...
芒格没有直接点名批评VaR模型，但他对这类思维方式的批判贯穿了他关于“[物理学妒忌](/model/physics-envy)”的所有论述。物理学妒忌的本质就是地图谬误的一个变体：以为只要地图画得足够精密，就能替代对疆域的真实了解。

---

## 反直觉与边界

**第一个反直觉：更精密的地图不一定更好。** 这是最难接受的一点。我们的直觉告诉我们，信息越多、模型越精密，决策应该越好。但如果额外的精密度制造了虚假的确定感，它反而会让决策变差。一个说“这家企业大概值每股50到70块”的粗略估算，可能比一个说“[内在价值](/model/intrinsic-value)为每股63.47美元”的DCF模型更有用——因为前者诚实地承认了不确定性，后者则把不确定性藏在了小数点后面。芒格多次引用凯恩斯的话：“宁要模糊的正确，不要精确的错误。”
...
**第四个边界：没有地图也不行。** 承认地图不是疆域，不意味着你应该丢掉所有地图，裸奔在疆域中。人类的认知能力有限，我们不可能直接把握一个[复杂系统](/model/complex-systems)的全部现实。地图——模型、理论、框架——是我们与复杂性打交道的必要工具。关键不是抛弃地图，而是在使用地图的同时保持一种清醒的觉知：这是简化的表示，不是完整的现实。地图在手，心中有数。
...
芒格的投资哲学中有一种深层的认识论谦逊：他知道自己使用的所有分析工具都是地图，没有一张是疆域本身。所以他坚持[安全边际](/model/margin-of-safety)——因为你的地图一定有遗漏的悬崖；所以他坚持[能力圈](/model/circle-of-competence)——因为你只能在自己亲身走过的疆域中校准地图的准确性；所以他反对[物理学妒忌](/model/physics-envy)——因为那本质上就是把数学地图当成了物理现实。
...
- [物理学妒忌](/model/physics-envy) — 物理学妒忌的本质就是把数学模型这张“地图”当成了现实的“疆域”
- [安全边际](/model/margin-of-safety) — 因为地图一定有误差，所以你需要安全边际来缓冲地图的不准确
- [能力圈](/model/circle-of-competence) — 你只在自己熟悉的疆域中才知道哪些地图靠谱、哪些地图骗人
- [奥卡姆剃刀](/model/occams-razor) — 简单的地图比复杂的地图更不容易让你产生“已经理解全貌”的幻觉
- [会计作为商业语言及其局限](/model/accounting-as-language-its-limits) — 财务报表是最常被误当成疆域的那张地图
- [二阶效应](/model/second-order-thinking) — 地图画不出二阶效应，因为简化表示天然倾向于呈现线性的一阶关系
- [铁锤人倾向](/model/man-with-a-hammer-syndrome) — 只用一张地图看世界，就是铁锤人的一种表现
