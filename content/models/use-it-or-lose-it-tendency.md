...
sourceUrl: "https://mungermodels.com/models/use-it-or-lose-it-tendency"
---
...
- **[衰老错误影响倾向](/model/senescence-misinfluence-tendency)**：衰老与不用就忘叠加时效果倍增——年龄增长降低了大脑维持技能的基线能力，不用则加速退化
- **[奖励和惩罚超级反应倾向](/model/reward-and-punishment-superresponse-tendency)**：为终身操练设计激励结构——让练习本身有回报，而不是依赖意志力
- **[避免不一致性倾向](/model/inconsistency-avoidance-tendency)**：人们倾向于只练习已经擅长的技能（维持一致性），而忽视那些退化中的短板
- **[错误衡量易得性倾向](/model/availability-misweighing-tendency)**：最常用的技能在记忆中最易得，导致人们误以为“我还行”——而那些不常用但重要的技能正在无声退化
- **[好奇心倾向](/model/curiosity-tendency)**：好奇心是[终身学习](/model/lifelong-learning)和练习的天然驱动力——对新知识的好奇让操练变得不像苦差事
