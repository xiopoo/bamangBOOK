...
sourceUrl: "https://mungermodels.com/models/trade-off-analysis"
---
...
芒格把这种工程学的清醒引入了商业和投资领域。他最常引用的概念之一就是[机会成本](/model/opportunity-cost)——这正是权衡思维在经济学中的直接体现。
...
- [机会成本](/model/opportunity-cost) — 权衡分析在经济学中的核心体现：每个选择都有放弃的替代方案
- [安全边际](/model/margin-of-safety) — 安全边际本身就是一种取舍：用更低的预期回报换取更大的容错空间
- [能力圈](/model/circle-of-competence) — 芒格最重要的权衡之一：用范围的限制换取判断的准确性
- [逆向思维](/model/inversion) — 好的权衡分析需要逆向思考：这个选择最糟糕的后果是什么？
- [检查清单方法](/model/checklist-method) — 检查清单帮助系统化地考虑取舍的各个维度，避免遗漏
- [风险优先](/model/risk-first) — 权衡中最重要的维度往往是风险：潜在的不可逆损失
- [耐心与纪律](/model/patience-discipline) — 长期框架下的最优取舍往往需要短期的耐心和纪律
